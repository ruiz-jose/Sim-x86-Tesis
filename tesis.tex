...
\hypertarget{resultados-de-la-encuesta-de-retroalimentaciuxf3n-ver-apuxe9ndice-anexo-b-refanexoc}{%
\subsection{Resultados de la encuesta de retroalimentación (ver Apéndice: Anexo B \ref{anexoC})}\label{resultados-de-la-encuesta-de-retroalimentaciuxf3n-ver-apuxe9ndice-anexo-b-refanexoc}}

Se presenta a continuación el análisis de la encuesta aplicada tras la unidad ``Ciclo de Instrucción'' y el uso del simulador VonSim8. Para detalles completos y gráficos, ver el capítulo ``Análisis de resultados de la encuesta''.

\begin{itemize}
\item
  \textbf{Resumen de resultados:}\\
  La encuesta aplicada tras la unidad ``Ciclo de Instrucción'' y el uso del simulador VonSim8 contó con 14 respuestas. Los estudiantes valoraron positivamente la experiencia, destacando la utilidad del simulador para comprender el ciclo de instrucción y la interacción entre componentes. Los promedios de los ítems Likert reflejan una alta satisfacción general con la herramienta.
\item
  \textbf{Principales hallazgos cuantitativos y cualitativos:}\\
  En los ítems cuantitativos, la visualización gráfica, el editor de ensamblador y la progresividad de instrucciones obtuvieron las puntuaciones más altas. Los comentarios abiertos resaltan la claridad de la interfaz, la facilidad para experimentar con ejemplos y la utilidad de las métricas de rendimiento. Algunos estudiantes sugirieron mejorar la documentación y agregar más ejercicios prácticos. Los resultados cualitativos muestran que el simulador facilita el aprendizaje autónomo y la comprensión de conceptos complejos.
\item
  \textbf{Conclusión propuesta:}\\
  El análisis de la encuesta evidencia que VonSim8 es una herramienta pedagógica efectiva para la enseñanza de arquitectura de computadoras. Los estudiantes perciben mejoras en su comprensión y habilidades prácticas, y valoran positivamente la usabilidad y utilidad didáctica del simulador. Se recomienda continuar con el desarrollo de recursos de apoyo y ejercicios, y mantener la retroalimentación de los usuarios para futuras mejoras.
\end{itemize}
...
\hypertarget{encuesta-de-validaciuxf3n-unidad-ciclo-de-instrucciuxf3n-y-simulador-vonsim8-docentes}{%
\subsection{2) Encuesta de validación -- Unidad Ciclo de Instrucción y simulador VonSim8 docentes}\label{encuesta-de-validaciuxf3n-unidad-ciclo-de-instrucciuxf3n-y-simulador-vonsim8-docentes}}
...
\item
  ...
  \end{itemize}
\item
  ¿Has utilizado simuladores educativos en tus clases anteriormente?
  ...
  \end{itemize}
\item
  ¿Qué tan familiarizado/a estabas con el ciclo de instrucción antes de utilizar el simulador VonSim8?
...
\tightlist
\item
  El material didáctico proporciona explicaciones claras y completas sobre las etapas del ciclo de instrucción (captación y ejecución).\\
\item
  Las tablas, esquemas e imágenes del material son útiles para enseñar conceptos abstractos como modos de direccionamiento y microoperaciones.\\
\item
  Los ejemplos prácticos (MOV, ADD, SUB, JMP) son adecuados para ilustrar las microoperaciones y el flujo de datos.\\
\item
  El material permite a los estudiantes conectar la teoría con la práctica de manera efectiva.\\
\item
  Las actividades propuestas (análisis, ejercicios, simulaciones) son apropiadas para consolidar los conceptos clave.
\end{enumerate}
...
\tightlist
\item
  El simulador facilita la visualización de los cambios en registros y memoria durante la ejecución de los programas.\\
\item
  El simulador permite a los estudiantes comprender mejor el ciclo de instrucción y las microoperaciones.\\
\item
  La representación gráfica del flujo de datos y las señales de control es clara y didáctica.\\
\item
  La interfaz del simulador es intuitiva y fácil de usar para los estudiantes.\\
\item
  La activación progresiva del repertorio de instrucciones es útil para evitar la sobrecarga cognitiva en los estudiantes.\\
\item
  Las métricas de rendimiento (CPI, tiempo de CPU, etc.) son útiles para enseñar conceptos relacionados con la eficiencia del procesador.
\end{enumerate}
...
\textbf{Gracias por tu tiempo y colaboración. Tus respuestas nos ayudarán a mejorar el simulador VonSim8 y los materiales didácticos asociados para futuros docentes y estudiantes.}

\hypertarget{anexoC}{%
\section{Anexo C: Análisis de resultados de la encuesta}\label{anexoC}}

\hypertarget{resumen-1}{%
\section{Resumen}\label{resumen-1}}

En este capítulo se presentan los resultados de una encuesta aplicada a estudiantes tras la unidad ``Ciclo de Instrucción'' y el uso del simulador \textbf{VonSim8}. Se incluye un análisis cuantitativo (promedios y gráficos) y una síntesis cualitativa de los comentarios abiertos.
...
\item
  Tamaño muestral: \textbf{n = 14} respuestas.
\item
  Tipo de preguntas: ítems Likert (1 a 5) y preguntas abiertas.
\end{itemize}

\hypertarget{datos-cuantitativos-promedios-de-uxedtems}{%
\section{Datos cuantitativos (promedios de ítems)}\label{datos-cuantitativos-promedios-de-uxedtems}}

\hypertarget{visualizaciones}{%
\section{Visualizaciones}\label{visualizaciones}}

\hypertarget{interpretaciuxf3n-y-discusiuxf3n-resumen}{%
\section{Interpretación y discusión (resumen)}\label{interpretaciuxf3n-y-discusiuxf3n-resumen}}

A partir de los promedios observados (tabla anterior), se destacan los siguientes puntos:
- Los ítems relacionados con la \textbf{calidad del material} y las \textbf{actividades} (Q5, Q6, Q7) obtienen promedios elevados (mayor o igual a 4.1), lo que sugiere que el material y los recursos visuales fueron bien valorados por el estudiantado.
- El \textbf{simulador} recibe valoraciones buenas en cuanto a conectar teoría y práctica (Q9 = 4.14) y ser útil para visualizar cambios (Q8 = 3.79), aunque la intuición/uso (Q10 = 3.93) y la visualización detallada de microoperaciones (Q11 = 3.57) muestran margen de mejora.
- La \textbf{mejora percibida} en el conocimiento del ciclo de instrucción es alta (Q14 = 4.00), lo cual apoya la efectividad pedagógica de la unidad.

\hypertarget{suxedntesis-cualitativa-comentarios-abiertos}{%
\section{Síntesis cualitativa (comentarios abiertos)}\label{suxedntesis-cualitativa-comentarios-abiertos}}

Los comentarios abiertos (13 respuestas en esa sección) coinciden en que lo más útil fue:
- El \textbf{seguimiento paso a paso} con el simulador para observar el flujo de ejecución y el comportamiento de registros y memoria.
- Las \textbf{actividades prácticas} que emplean VonSim8.
- Dificultades recurrentes mencionadas: comprensión de las \textbf{banderas}, lectura/escritura en memoria, y percibir las animaciones del simulador.
...
\hypertarget{conclusiuxf3n-propuesta-para-incorporar-en-la-tesis}{%
\section{Conclusión propuesta (para incorporar en la tesis)}\label{conclusiuxf3n-propuesta-para-incorporar-en-la-tesis}}
