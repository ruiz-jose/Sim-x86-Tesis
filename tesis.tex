...
\subsection{Instrumentos de recolección de datos}\label{instrumentos-de-recolecciuxf3n-de-datos}}
...
\tightlist
\item
  \textbf{Encuestas pre y post-uso:} Aplicadas antes y después de la utilización del simulador, orientadas a medir la autopercepción de conocimientos y habilidades.
\item
  \textbf{Cuestionarios de conocimiento:} Pruebas objetivas sobre conceptos específicos (ciclo de instrucción, registros, interrupciones) administradas en ambos momentos.
\item
  \textbf{Registro de tiempo de uso:} Análisis del tiempo dedicado por cada estudiante a la interacción con el simulador.
\item
  \textbf{Entrevistas semiestructuradas:} Realizadas a una muestra de participantes para profundizar en la experiencia de uso y recoger sugerencias de mejora.
\end{itemize}
...
\tightlist
\item
  \textbf{Comparación de puntajes pre y post-uso:} Se emplearán pruebas estadísticas (t de Student para muestras relacionadas) para determinar diferencias significativas en el nivel de conocimiento.
\item
  \textbf{Análisis descriptivo del tiempo de uso:} Se correlacionará el tiempo de interacción con el simulador y la mejora en los puntajes.
\item
  \textbf{Análisis temático de entrevistas:} Se identificarán patrones recurrentes en las percepciones y sugerencias de los estudiantes.
\end{itemize}
