...
\begin{itemize}
\item
  \textbf{Cuestionario de conocimiento:} Dirigido a estudiantes, utiliza una escala tipo Likert (por ejemplo, 1-5) para evaluar la satisfacción y la percepción de eficacia en aspectos clave del simulador, tales como visualización, editor, progresividad de instrucciones, métricas, documentación y manejo de periféricos. Incluye además un apartado para comentarios abiertos.
\item
...
\addcontentsline{toc}{chapter}{Apéndices A}
...
\addcontentsline{toc}{chapter}{Apéndices B}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0419}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0479}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0838}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0958}}
...
\bottomrule\noalign{}
\endlastfoot
1 & 2025-ES-014 & 2025-09-20 & 1 & 35 & paso\_a\_paso & editor, RTL, metricas & suma.asm & si & Problema con JZ \\
