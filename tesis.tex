...
\hypertarget{resultados-de-la-encuesta-de-retroalimentaciuxf3n}{%
\subsection{Resultados de la encuesta de retroalimentación}\label{resultados-de-la-encuesta-de-retroalimentaciuxf3n}}

Se presenta a continuación una síntesis del análisis de la encuesta aplicada tras desarrollar el tema ciclo de instrucción y el uso del simulador VonSim8. Para información detallada y gráficos complementarios, véase apéndice anexo C \ref{anexoC}.

\begin{itemize}
\item
  \textbf{Resumen de resultados:}\\
  La encuesta fue respondida por 14 estudiantes y permitió evaluar la claridad de los contenidos, la calidad del material didáctico y la utilidad del simulador. En general, los participantes expresaron una valoración positiva de la experiencia, destacando que el simulador favoreció la comprensión del ciclo de instrucción y la relación entre los distintos componentes del procesador. Los promedios obtenidos en las escalas tipo Likert reflejan un alto nivel de satisfacción tanto con el material teórico como con las actividades prácticas y el uso del simulador.
\item
  \textbf{Principales hallazgos cuantitativos y cualitativos:}\\
  Los ítems mejor valorados fueron los recursos visuales (promedio 4.21), la claridad de los modos de direccionamiento (4.14) y la conexión entre teoría y práctica (4.14). En cambio, la visualización de las microoperaciones obtuvo la puntuación más baja (3.57), señalando una posible necesidad de optimización en este aspecto.
  En las respuestas abiertas, los estudiantes destacaron como aspectos más útiles la posibilidad de observar paso a paso la ejecución de instrucciones y los cambios en registros y memoria, así como el carácter práctico e intuitivo del simulador. Las principales dificultades se centraron en la interpretación de las banderas, las animaciones de lectura/escritura en memoria y las instrucciones de salto, lo que sugiere la conveniencia de incorporar explicaciones o recursos adicionales.
\item
  \textbf{Conclusión propuesta:}\\
  El análisis de la encuesta confirma que VonSim8 constituye una herramienta pedagógica eficaz para la enseñanza de la arquitectura de computadoras, al facilitar la comprensión del funcionamiento interno del procesador y promover el aprendizaje activo. Los estudiantes perciben una mejora significativa en sus conocimientos sobre el ciclo de instrucción y valoran especialmente la integración entre teoría, práctica y simulación. Se recomienda continuar perfeccionando las representaciones visuales y ampliar los materiales de apoyo para fortalecer la experiencia de aprendizaje.
\end{itemize}
...
\hypertarget{anexoC}{%
\section{Anexo C: Análisis de los resultados de la encuesta de retroalimentación}\label{anexoC}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0548}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6027}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0503}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7233}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Aspecto evaluado
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
