...
Esta sección detalla los requisitos funcionales y pedagógicos que guiaron el diseño del simulador, en base a los objetivos didácticos establecidos en el capítulo introductorio (\ref{intro}). Su definición se apoyó en principios pedagógicos y técnicos, y se complementó con una validación empírica basada en entrevistas semiestructuradas a docentes expertos. Este proceso permitió identificar necesidades concretas del aula, así como carencias en las herramientas existentes (ver Anexo A \protect\hyperlink{ref-ref}{\textbf{ref?}}(anexoA)). La metodología cualitativa basada en entrevistas semiestructuradas permitió identificar necesidades auténticas del aula, aportando una base empírica sólida para la definición técnica de los requerimientos funcionales y pedagógicos \protect\hyperlink{ref-huberman2019qualitative}{{[}60{]}}.
...
{\centering \includegraphics[width=0.9\linewidth]{images/requisitos} 

}

\caption{Resumen requisitos}\label{fig:requisitos}
\end{figure}
...
Para el diseño del simulador desarrollado en este trabajo, se tomó como referencia el simulador VonSim\footnote{VonSim: \url{https://vonsim.github.io/}}, una herramienta educativa basada en la arquitectura de Von Neumann que permite visualizar y experimentar el ciclo de instrucción de una manera interactiva. Esta herramienta sirvió como base conceptual y funcional debido a su enfoque didáctico y su estructura visual clara, orientada a la enseñanza de principios fundamentales de arquitectura de computadoras \protect\hyperlink{ref-vonsim}{{[}72{]}}.
