...
Las aplicaciones de la simulación en distintos sectores se resumen en la Tabla \ref{tab:aplicacionessimulacion}, donde se detallan los ámbitos de uso, ejemplos representativos y los principales beneficios asociados a cada área.
...
La Figura \ref{fig:editor} ilustra la interfaz del editor ensamblador implementado en el simulador, evidenciando las funcionalidades mencionadas y su aporte al proceso de aprendizaje.
