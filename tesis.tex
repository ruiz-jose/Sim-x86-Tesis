...
\midrule
\textbf{Registro Rx} & Puede ser:\begin{itemize} \item registro Ry (1)\item dirección [M] (2)\item dirección registro [BL] (3)\item valor inmediato d (4)\end{itemize} & MOV Rx, Ry\\
\textbf{Memoria} & Operando destino puede ser: \begin{itemize}\item dirección [M]\item dirección registro [BL] \end{itemize} y operando fuente puede ser:\begin{itemize} \item Registro: Ry\item valor en la instrucción d \end{itemize} & MOV [M], Ry\\
...
\hypertarget{repertorio-de-instrucciones-2}{%
\section{Repertorio de instrucciones}\label{repertorio-de-instrucciones-2}}
...
\hypertarget{ciclo-de-ejecuciuxf3n}{%
\section{Ciclo de ejecución}\label{ciclo-de-ejecuciuxf3n}}
