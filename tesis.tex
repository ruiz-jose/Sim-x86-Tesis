...
Transferencia y procesamiento & A: entre registros & ----XXYY & XX = Registro destino, YY = Registro fuente\\
 & B: Cargar a registro & ----XX00 MMMMMMMM & XX = Registro destino, M = Dirección de memoria\\
 & C: Almacenar en memoria & ----00YY MMMMMMMM & YY = Registro fuente, M = Dirección de memoria\\
\midrule\\
Control & D: control de flujo & ----ffff MMMMMMMM & ffff = funcionalidad, M = Dirección de memoria\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
\item
  \texttt{-\/-\/-\/-}: Código de operación de la instrucción, número de 4 bits.
\item
