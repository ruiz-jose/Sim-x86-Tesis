...
Para facilitar el aprendizaje de la programación en ensamblador e introducir el ciclo de instruccion se propone el siguente repertorio de instrucciones, luego cuando se avance sobre los modulos de entrada y salida se presentan más instrccciones.
...
\addlinespace[10pt]
\textbf{D} & \texttt{HLT} & 1 & \texttt{1101 0000 00000000}\\
\addlinespace[10pt]
\bottomrule
\end{tabular}}
\end{table}
...
\textbf{Control de flujo} \textbar{} \texttt{JMP\ /\ Jxx\ /\ CALL\ /\ RET} \textbar{} \{12\} \textbar{} Salto incondicional \texttt{JMP}, condicionales \texttt{Jxx}, llamada \texttt{CALL}, retorno \texttt{RET} \textbar{}

\textbf{Manejo de pila y E/S} \textbar{} \texttt{PUSH\ /\ POP\ /\ OUT\ /\ IN} \textbar{} \{13\} \textbar{} \texttt{PUSH}: poner en la pila\texttt{POP}: retirar de la pila\texttt{OUT}: enviar a puerto\texttt{IN}: recibir desde puerto \textbar{}

\textbf{Manejo de interrupción}\textbar{} \texttt{INT\ /\ IRET\ /\ NOP\ /\ HLT}\textbar{} \{14\} \textbar{} \texttt{INT}: llamar rutina de interrupción\texttt{IRET}: retornar de interrupción\texttt{NOP}: no opera\texttt{HLT}: detiene el CPU \textbar{}

\textbf{Miscelánea} \textbar{} \texttt{AND\ /\ OR\ /\ XOR\ /\ NOT} \textbar{} \{15\} \textbar{} Operaciones lógicas \textbar{}
