...
Esta sección describe los componentes de la Unidad Central de Procesamiento (CPU) del simulador VonSim8, destacando su analogía con elementos presentes en arquitecturas reales. Esta correspondencia busca potenciar el valor pedagógico del simulador como recurso didáctico para la enseñanza de Arquitectura de Computadoras.
El diseño de los registros fue concebido para facilitar la comprensión de los modos de direccionamiento y del ciclo de instrucción, ambos considerados fundamentos clave en el estudio de la Arquitectura de Computadoras \protect\hyperlink{ref-stallings_computer_2021}{{[}14{]}}. Se describe en la siguiente tabla \ref{tab:arq}:
...
\addlinespace[10pt]
\textbf{} & Dos registros dedicados a la transferencia de información entre la CPU y la memoria principal: el MAR (Memory Address Register), encargado de almacenar direcciones de memoria, y el MBR (Memory Buffer Register), que contiene los datos a transferir.\\
\addlinespace[10pt]
