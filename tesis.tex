...
El formalismo DEVS define el comportamiento de un sistema real a través de eventos de entrada y salida, así como transiciones entre estados específicos. Un modelo DEVS se compone de modelos atómicos y modelos acoplados. Los modelos atómicos representan las unidades básicas de comportamiento del sistema, mientras que los modelos acoplados consisten en combinaciones de modelos atómicos y/o otros modelos acoplados. Esta estructura jerárquica permite gestionar y analizar sistemas complejos de manera eficiente, facilitando la prueba de subsistemas de manera aislada antes de integrarlos en el sistema completo. En términos generales, un modelo DEVS está caracterizado por la generación de eventos de salida \(Y\), en función del estado \(S\) en el que se encuentre y las entradas \(X\) recibidas, cada cierto intervalo de tiempo.

\hypertarget{descripciuxf3n-del-formalismo-devs-1}{%
\subsection{Descripción del formalismo DEVS}\label{descripciuxf3n-del-formalismo-devs-1}}
