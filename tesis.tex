...
La tabla @ref(tab:tab\_mod\_dir) detalla el cálculo de la dirección para cada modo de direccionamiento.

\begin{longtable}[]{@{}llll@{}}
\caption{(\#tab:tab\_mod\_dir )Modos de direccionamiento básicos}\tabularnewline
\toprule
