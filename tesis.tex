...
- Arquitectura \emph{von Neumann}, memoria de datos e instrucciones compartidas.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.47\columnwidth}\raggedright
\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
...
\section{Formato de instrucciones}\label{formato-de-instrucciones}}

Las instrucciones están codificadas con 1, 2 o 3 bytes. Los primeros 4 bits identifican el \texttt{opcode} de la instrucción, el resto de los bits indican los parámetros. Existen 4 posibles codificaciones de parámetros.
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
C: directo: memoria/inmediato a registro\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
D: directo: inmediato a memoria\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{OOOO\ \ mmmm\ DDDDDDDD}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{DDDDDDDD} = Dirección de memoria o Inmediato\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}

Las instruciones de transferencia y operaciones en la ALU soportan todos esos formatos de instrucicones.
Según los primeros 4 bits de la instrucción opcode es como se interpretan los 4 bits restantes.
...
\midrule
\endhead
\texttt{MOV\ \ Rx,\ Ry} & \texttt{Rx} \(\leftarrow\) \texttt{Ry} & \texttt{0000\ XXYY}\tabularnewline
\texttt{ADD\ \ Rx,\ Ry} & \texttt{Rx} \(\leftarrow\) \texttt{Rx\ +\ Ry} & \texttt{0011\ XXYY}\tabularnewline
\texttt{SUB\ \ Rx,\ Ry} & \texttt{Rx} \(\leftarrow\) \texttt{Rx\ -\ Ry} & \texttt{0100\ XXYY}\tabularnewline
\texttt{CMP\ \ Rx,\ Ry} & Modifica \emph{flags} de \texttt{Rx\ -\ Ry} & \texttt{0101\ XXYY}\tabularnewline
\texttt{MOV\ Rx,\ {[}M{]}} & \texttt{Rx} \(\leftarrow\) \texttt{Mem{[}M{]}} & \texttt{0001\ XX\ DDDDDDDD}\tabularnewline
