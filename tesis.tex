...
Estos modos se ilustran en la figura \ref{fig:ModDir}:
...
\textbackslash caption\{Modos de direccionamiento {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}\}\label{fig:ModDir}
...
\item
  ...
  \tightlist
  \item
    = contenido de la posición de memoria X o del registro X
  \end{enumerate}
\end{itemize}
...
\textbackslash caption\{Formato de instrucciones x86 {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}\}\label{fig:FormatoInst}
\textbackslash end\{figure\}
