...
\textbf{Transferencia y procesamiento} & B: Almacenar en memoria & Operando destino puede ser: \begin{itemize} \item dirección [M]\item dirección registro [BL] \end{itemize} y operando fuente puede ser:\begin{itemize} \item Registro: Ry\item valor en la instrucción d \end{itemize}\\
\textbf{Control} & C: control de flujo & Si tiene operando es una dirección de memoria M (*)\\
\midrule
\bottomrule
\end{tabular}
\begin{tablenotes}
