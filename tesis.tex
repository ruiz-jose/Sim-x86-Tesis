...
6. \textbf{\texttt{IP} \(\leftarrow\) \texttt{MBR}}: El contenido del \texttt{MBR} se transfiere al registro \texttt{IP}, estableciendo la nueva dirección de ejecución.
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Se obtiene el operando de la instrucción.
    \end{enumerate}
  \item
