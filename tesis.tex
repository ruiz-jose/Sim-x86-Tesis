...
\item
  ...
  \tightlist
  \item
    Visualizar el flujo de datos mediante una representación en el nivel de transferencia entre registros (Register Transfer Level, RTL), que describe cómo los datos se mueven entre componentes internos como registros y buses durante cada etapa del ciclo de instrucción. En la obra de Stallings \protect\hyperlink{ref-stallings_computer_2021}{{[}14{]}}, es común el uso del nivel de transferencia entre registros (RTL) para representar cada etapa del ciclo de instrucción, desde la captura (`fetch') hasta la ejecución (`execute'). Este enfoque facilita la comprensión del procesador, ya que permite visualizar el recorrido de los datos entre registros y la activación de señales de control en cada etapa.
  \end{itemize}
...
\hypertarget{fundamentaciuxf3n-de-la-arquitectura-del-simulador}{%
\section{Fundamentación de la arquitectura del simulador}\label{fundamentaciuxf3n-de-la-arquitectura-del-simulador}}
...
\midrule
\textbf{Transferencia de datos} & MOV & \begin{itemize} \item 0 - Operación entre registros \item 1 - Operación carga a registro \item 2 - Operación almacena en memoria \end{itemize}\\
\addlinespace[8pt]
\textbf{Pocesamiento de datos} & ADD & 3-4-5 Sumar\\
\addlinespace[8pt]
\textbf{} & SUB & 6-7-8 Restar\\
\addlinespace[8pt]
\textbf{} & CMP & 9-10-11 Comparar\\
\addlinespace[8pt]
\textbf{Control de flujo} & JMP & 12-a Salto incondicional\\
\addlinespace[8pt]
\addlinespace
