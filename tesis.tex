...
Con el propósito de complementar la tabla de requisitos funcionales y brindar una visión integrada del diseño del simulador, se diseñó un diagrama estructural que muestra los módulos principales (Unidad de Control, Módulo E/S, Visualizador RTL, etc.) y sus interacciones, facilitando así la comprensión del flujo interno del simulador.
