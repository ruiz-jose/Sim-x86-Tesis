...
Esta sección presenta los componentes que conforman la Unidad Central de Procesamiento (CPU) del simulador VonSim8, resaltando su correspondencia con elementos propios de arquitecturas reales, con el propósito de fortalecer su valor pedagógico en el contexto de la enseñanza de arquitectura de computadoras.
El diseño de los registros busca facilitar la comprensión de los modos de direccionamiento y del ciclo de instrucción, considerados pilares conceptuales en la enseñanza de la arquitectura de computadoras. Se describe en la siguiente tabla \ref{tab:arq}:
...
El repertorio de instrucciones fue diseñado como una abstracción intencionada de la arquitectura x86, con el propósito de optimizar los procesos de enseñanza y aprendizaje en el contexto educativo. En una etapa inicial del proceso de enseñanza, se incluyen únicamente aquellas instrucciones esenciales que permiten introducir progresivamente los contenidos básicos de la asignatura Arquitectura de Computadoras. Este enfoque gradual facilita la comprensión de los conceptos fundamentales evitando la complejidad innecesaria que podría dificultar la comprensión en las etapas iniciales del aprendizaje \protect\hyperlink{ref-hennessy2017computer}{{[}13{]}}. La Tabla \ref{tab:setreducido} muestra un conjunto reducido de instrucciones que abarca las operaciones más frecuentes y pertinentes para una etapa introductoria de aprendizaje. Este repertorio se centra en las instrucciones de transferencia y procesamiento de datos, así como en las instrucciones de control de flujo, permitiendo al estudiante familiarizarse con los conceptos básicos de la arquitectura x86 sin la complejidad adicional de un repertorio completo.
