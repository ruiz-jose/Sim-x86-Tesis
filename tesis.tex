...
\def\labelenumi{\arabic{enumi}.}
\item
  La evaluación de Herramientas Existentes se llevo a cabo en el capitulo anterior, donde se Estudió y evaluó diferentes herramientas actuales de simulación destinadas a apoyar la enseñanza de la arquitectura x86. Este objetivo se cumplió mediante una revisión exhaustiva de las herramientas de simulación disponibles y posterior publicación de los resultados.
\item
  Desarrollo de una Nueva Herramienta de Simulación: es este capitulo se centra en el Diseño y construcción de una herramienta de apoyo para impartir los contenidos de la asignatura Arquitectura de Computadoras, que sea intuitiva y fácil de usar para estudiantes y profesores.
\end{enumerate}
