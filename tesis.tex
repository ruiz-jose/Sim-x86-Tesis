...
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{0101\ XXYY}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{ADD,\ SUB\ y\ CMP}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
Poseen los mismos formato de instruccion que MOV por con su opcode\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{-\/-\/-\/-\ -\/-\/-\/-\ -\/-\/-\/-\/-\/-\/-\/-\ -\/-\/-\/-\/-\/-\/-\/-}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{JMP\ M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{PC} \(\leftarrow\) \texttt{M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
\texttt{JC\ M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
Si \texttt{flag\ C=1} entonces \texttt{PC} \(\leftarrow\) \texttt{M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
\texttt{JZ\ M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
Si \texttt{flag\ Z=1} entonces \texttt{PC} \(\leftarrow\) \texttt{M}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
