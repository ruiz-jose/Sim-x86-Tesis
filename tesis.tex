...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{6cm}}
\toprule
\multicolumn{1}{>{\centering\arraybackslash}p{6cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Tipo}}} & \multicolumn{1}{>{\centering\arraybackslash}p{4cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Operación}}} & \multicolumn{1}{>{\centering\arraybackslash}p{6cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Parámetros}}}\\
\midrule
\textbf{} & A: Entre registros & Operandos son registros `Rx`,`Ry`\\
\addlinespace[8pt]
\textbf{Transferencia y procesamiento} & B: Cargar a registro & Operando destino registro `Rx` y operando fuente puede ser Directo: dirección `[M]`/ Indirecto: dirección registro BL `[BL]`/Inmediato: valor en la instrucción `d`\\
\addlinespace[8pt]
\textbf{} & C: Almacenar en memoria & Operando destino puede ser Directo: dirección `[M]`/ Indirecto dirección registro BL `[BL]` y operando fuente se obtiene del Registro: `Ry`/Inmediato: valor en la instrucción `d`\\
\addlinespace[8pt]
