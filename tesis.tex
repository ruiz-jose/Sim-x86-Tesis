...
Una vez incorporado el repertorio esencial de instrucciones, el siguiente paso en la secuencia didáctica es abordar el flujo interno de datos dentro del procesador. Representar el ciclo de instrucción desde una perspectiva microarquitectónica permite al estudiante comprender cómo se ejecutan las operaciones a nivel de hardware, visualizando tanto los registros involucrados como las señales de control.
...
Para el diseño del simulador desarrollado en este trabajo, se tomó como referencia el simulador VonSim\footnote{VonSim: \url{https://vonsim.github.io/}}, una herramienta educativa basada en la arquitectura de Von Neumann que permite visualizar y experimentar el ciclo de instrucción de una manera interactiva. Esta herramienta sirvió como base conceptual y funcional debido a su enfoque didáctico y su estructura visual clara, orientada a la enseñanza de principios fundamentales de arquitectura de computadoras \protect\hyperlink{ref-vonsim}{{[}71{]}}.
