...
En caso de tener interrupciones y no indicarse la directiva \texttt{org}, el simulador asigna automáticamente la dirección 0x08 al primer byte del programa, porque las interrupciones se gestionan a partir de la dirección \texttt{0x00h} al \texttt{0x08h}.
