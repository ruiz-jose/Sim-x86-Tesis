...
\midrule
\textbf{Arquitectura} & Von Neumann, con memoria compartida para datos e instrucciones.\\
\addlinespace[10pt]
\textbf{Registros} & 4 registros de propósito general (`AL`, `BL`, `DL` y `DL`) de 8 bits cada uno.\\
\addlinespace[10pt]
\textbf{} & 4 registros de propósito específico: `IP` (Instruction Pointer),`IR`(Instruction Register), `SP`(Stack Pointer) y `RS` (registro de estado)\\
\addlinespace[10pt]
