...
La Tabla @ref(tab:data\_algoritmo) indica el cálculo de la dirección realizado para cada modo de direccionamiento.

\begin{longtable}[]{@{}llll@{}}
\caption{(\#tab:data\_algoritmo)Modos de direccionamiento básicos}\tabularnewline
\toprule
...
\caption{Formato de instrucciones x86}\label{fig:FormatoInst}
\end{figure}
