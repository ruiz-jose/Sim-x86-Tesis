...
Se describen los pasos de la etapa de captación de instrucciones mediante la transferencia entre diferentes componentes de la computadoras:
\textbar{} \# \textbar{} Pasos \textbar{}
\textbar{} - \textbar{} --- \textbar{}
\textbar{} 1 \textbar{} \texttt{MAR} \(\leftarrow\) \texttt{IP} \textbar{}
\textbar{} 2 \textbar{} \texttt{MDR} \(\leftarrow\) \texttt{read(Memoria{[}MAR{]});\ IP\ \$\textbackslash{}leftarrow\$\ IP\ +\ 1} \textbar{}
\textbar{} 3 \textbar{} \texttt{IR} \(\leftarrow\) \texttt{MDR} \textbar{}
