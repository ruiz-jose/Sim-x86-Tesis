...
\item
  ...
  Incluir una representación gráfica de la arquitectura básica de la computadora ---compuesta por CPU, buses, memoria y dispositivos de entrada/salida--- durante la ejecución de los programas. La visualización debe destacar los componentes activos en cada etapa del ciclo de ejecución, facilitando una comprensión sistémica e integrada del funcionamiento de la computadora \protect\hyperlink{ref-w3c_accessibility_2021}{{[}67{]}}. El uso de representaciones gráficas como recurso didáctico está respaldado por estudios que demuestran su efectividad para facilitar la comprensión de conceptos abstractos en disciplinas técnicas \protect\hyperlink{ref-sorva2013visualizations}{{[}68{]}}. La Figura \ref{fig:diagramasimulador} presenta un diagrama estructural que representa los principales módulos del simulador y sus interacciones. Este recurso visual permite integrar, de forma esquemática, los componentes funcionales implementados y su correspondencia con los objetivos pedagógicos definidos.
\end{enumerate}
...
En conjunto, estos requisitos constituyen la base del diseño del simulador, garantizando tanto su pertinencia pedagógica como su viabilidad técnica. Su formulación responde a la necesidad de contar con un recurso didáctico que facilite la enseñanza y el aprendizaje de la arquitectura x86, integrando aspectos visuales, interactivos y de análisis del rendimiento. La Tabla \protect\hyperlink{ref-ref}{\textbf{ref?}}(tab:requisitosresumen) presenta un resumen de los principales requisitos funcionales, junto con su fundamentación pedagógica y técnica.
...
A partir de los requisitos funcionales detallados anteriormente, se realizó un proceso colaborativo de análisis con docentes\footnote{Docentes: Marcelo A. Colombani y Amalia G. Delduca} de la asignatura Arquitectura de Computadoras. Su experiencia permitió identificar los elementos de la arquitectura x86 que debían representarse, simplificarse o adaptarse según los objetivos pedagógicos del simulador. Como resultado, se optó por una arquitectura simplificada de 8 bits, cuya elección se justifica por su valor didáctico: reduce significativamente la complejidad del modelo sin comprometer la enseñanza de conceptos fundamentales como el ciclo de instrucciones, la manipulación de registros o la gestión de interrupciones. Esta simplificación facilita la representación de procesos clave con mayor claridad y menor carga cognitiva, favoreciendo la comprensión de los estudiantes en las etapas iniciales del aprendizaje.

La arquitectura x86 se caracteriza por su elevada complejidad, derivada de su extenso repertorio de instrucciones y sus múltiples características avanzadas. En respuesta a esta complejidad, el diseño del simulador se fundamenta en tres principios pedagógicos centrales:
...
\item
  \textbf{Análisis crítico}: comparar el modelo simplificado con la arquitectura x86 real fomenta un aprendizaje reflexivo y profundo.
\item
...
\hypertarget{principales-caracteruxedsticas-tecnoluxf3gicas}{%
\subsubsection{Principales características tecnológicas}\label{principales-caracteruxedsticas-tecnoluxf3gicas}}

Su desarrollo integra tecnología moderna del ecosistema web y buenas prácticas de software, proporcionando una experiencia didáctica visual, modular y accesible.

\begin{itemize}
\item
  React: Framework de interfaz moderna para construir componentes interactivos y reactividad eficiente.
\item
  TypeScript: Tipado estático que aporta robustez y facilita el mantenimiento del código.
\item
  React Spring: Animaciones fluidas para mejorar la experiencia visual y pedagógica.
\item
  Jotai: Gestión de estado global, permitiendo sincronización y modularidad entre los distintos componentes.
\item
  Tailwind CSS: Framework de estilos utilitario para lograr interfaces responsivas y coherentes.
\item
  Pruebas Automatizadas: Tests unitarios, de integración y de accesibilidad (incluyendo ARIA, navegación por teclado y roles semánticos) para garantizar calidad y accesibilidad.
\item
  Arquitectura modular y educativa

  \begin{itemize}
  \tightlist
  \item
    Componentes independientes y reutilizables, lo que facilita tanto la extensión como el mantenimiento.
  \item
    Integración de paneles educativos, tutoriales interactivos y gamificación mediante sistemas de logros y niveles de aprendizaje.
  \item
    Adaptabilidad a distintos niveles (básico, intermedio, avanzado) y retroalimentación visual en tiempo real.
  \end{itemize}
\item
  Simulación fiel de arquitectura de computadoras

  \begin{itemize}
  \tightlist
  \item
    CPU de 8 bits: Registros, ALU, buses, ciclo de instrucción y modos de direccionamiento.
  \item
    Memoria RAM: Simulación de 256 bytes con direccionamiento de 8 bits.
  \item
    Lenguaje ensamblador: Permite escribir, ejecutar y depurar programas, visualizando el flujo de instrucciones y operandos.
  \item
    Sistema de E/S configurable: Integración de periféricos como teclado, pantalla, PIC, PIO y temporizador, siguiendo especificaciones reales de la familia Intel iAPX 88.
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Indicadores visuales avanzados para las fases de ejecución (fetch-decode-execute).
  \item
    Animaciones de flujo de datos y cambios de estado en tiempo real.
  \item
    Paneles flotantes y tooltips educativos para explicar conceptos clave y apoyar el aprendizaje autónomo.
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Documentación exhaustiva que facilita la comprensión de cada componente y concepto abordado.
  \item
    Recursos adicionales como tutoriales interactivos, referencia de instrucciones y guías de arquitectura.
  \end{itemize}
\item
  ...
  \item
    Enfoque en la accesibilidad y la inclusión educativa.
  \item
    Estrategias de testing, documentación y contribución enfocadas en el impacto pedagógico.
  \end{itemize}
\end{itemize}

En síntesis, VonSim es una herramienta robusta y accesible que, mediante la simulación práctica y una interfaz pedagógicamente orientada, simplifica y facilita la comprensión de conceptos complejos en arquitectura de computadoras.
...
Cuando el programa tiene instrucciones INT o de manejo de pila se resalta en memoria el el vector de interrucciones, 8 posiciones de memoria desde \texttt{0x00} a \texttt{0x07}:
...
VonSim8 solamente implementa las interrupciones por software:
...
Con el fin de facilitar el aprendizaje del simulador VonSim8 se implementó un tour de aprendizaje que guía a los usuarios a través de las características y funcionalidades del simulador. Tambien en centro de aprendizaje con explicación de ejemplos basicos.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1649}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3711}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4639}}@{}}
\toprule\noalign{}
...
\textbf{Directiva \texttt{org}} & Obligatoria. El código comienza en \texttt{0x2000h} y los datos en \texttt{0x1000h}. & Opcional. Por defecto, el código inicia en \texttt{0x00h}. Si hay interrupciones, comienza en \texttt{0x08h}. Compatible con \texttt{org\ 0x20h}. \\
...
\textbf{Interrupciones implementadas} & Completo soporte de interrupciones por hardware y software, con PIC. & Solo interrupciones por software: \texttt{INT\ 0} (fin), \texttt{INT\ 6} (entrada de teclado), \texttt{INT\ 7} (salida de cadena). \\
\textbf{Temporales de la ALU} & Registros temporales \texttt{left} y \texttt{rigth} visibles. & Eliminados, para simplificar la representación del ciclo de instrucción. \\
...
En esta sección se describe la estructura del simulador VonSim8. El diseño de los registros se concibió con un propósito pedagógico: facilitar la comprensión de los modos de direccionamiento y del ciclo de instrucción, elementos fundamentales en el estudio de la Arquitectura de Computadoras \protect\hyperlink{ref-stallings_computer_2021}{{[}20{]}}. Se describe en la siguiente tabla \ref{tab:estructuravonsim8} los componentes principales del simulador, junto con sus características y funcionalidades específicas. Esta tabla proporciona una visión general de la arquitectura del simulador, destacando los elementos clave que componen su estructura y su propósito pedagógico:
...
Los bits restantes del registro FLAGS se encuentran reservados para futuras extensiones del simulador y no son utilizados en la versión actual.
...
Dentro de los buses internos de la CPU se incluyen representaciones gráficas de multiplexores, componentes digitales esenciales que permiten seleccionar entre múltiples fuentes de datos o direcciones durante el ciclo de instrucción. Estos multiplexores permiten dirigir las señales adecuadas a los registros y a la ALU (Unidad Aritmético Lógica), facilitando así el flujo de datos dentro del procesador. Un multiplexor (MUX) es un conmutador digital que conecta datos de una de n fuentes a la salida. Están dotados de entradas de control capaces de seleccionar una, y solo una, de las entradas de datos para permitir su transmisión desde la entrada seleccionada hacia dicha salida \protect\hyperlink{ref-mano2017digital}{{[}81{]}}.

\hypertarget{perifuxe9ricos-teclado-y-pantalla}{%
\subsection{Periféricos: teclado y pantalla}\label{perifuxe9ricos-teclado-y-pantalla}}
...
La selección de estos bloques funcionales se fundamenta en dos criterios principales: por un lado, la necesidad de modelar los componentes esenciales de una computadora real; y por otro, la búsqueda de modularidad y claridad conceptual con fines pedagógicos. La Tabla \ref{tab:bloquesfuncionales} resume los principales bloques que conforman la arquitectura simulada, junto con una breve descripción de su funcionalidad.
...
Para facilitar el aprendizaje de la programación en ensamblador e introducir el ciclo de instruccion se propone el siguente repertorio de instrucciones, luego cuando se avance sobre los modulos de entrada y salida de acuerdo al programa de estudio de la asignatura Arquitectura de Computadoras \protect\hyperlink{ref-cd023_25_programa2025}{{[}82{]}}.
...
Las instrucciones del simulador VonSim8 poseen una longitud variable (1, 2 o 3 bytes), donde el primer byte contiene el código de operación (opcode) y los siguientes bytes pueden contener operandos adicionales según el modo de direccionamiento utilizado. El opcode determina la operación a realizar, mientras que los operandos especifican los datos o registros involucrados en la operación.
...
\midrule
\textbf{Registro Rx} & Puede ser:\begin{itemize} \item registro Ry\item dirección [M] \item dirección registro [BL] \item valor inmediato d \end{itemize} & \begin{itemize} \item Entre registro: MOV Rx, Ry\item Directo: MOV Rx, [M] \item Indirecto: MOV Rx, [BL]\item Inmediato: MOV Rx, d \end{itemize}\\
\addlinespace[10pt]
...
\begin{tablenotes}
\item \textit{Nota: } 
\item Las instrucciones de dos operando, tanto de transferencia y procesamiento tienen los mismos modos de direccionamiento.
\item Rx y Ry puede ser un registro de propósito general: AL, BL, CL y DL.
...
\addlinespace[10pt]
\textbf{4} & \texttt{ADD Rx, --} & Modos direccionamiento: destino registro & \texttt{0100 ---- --------}\\
\addlinespace[10pt]
\addlinespace
\textbf{5} & \texttt{ADD [M], --} & Modos direccionamiento: destino memoria & \texttt{0101 ---- -------- --------}\\
\addlinespace[10pt]
\textbf{6} & \texttt{SUB Rx, Ry} & 1 & \texttt{0110 RxRy}\\
\addlinespace[10pt]
\textbf{7} & \texttt{SUB Rx, --} & Modos direccionamiento: destino registro & \texttt{0111 ---- --------}\\
\addlinespace[10pt]
\textbf{8} & \texttt{SUB [M], --} & Modos direccionamiento: destino memoria & \texttt{1000 ---- -------- --------}\\
\addlinespace[10pt]
\textbf{9} & \texttt{CMP Rx, Ry} & 1 & \texttt{1001 RxRy}\\
\addlinespace[10pt]
\addlinespace
\textbf{A} & \texttt{CMP Rx, --} & Modos direccionamiento: destino registro & \texttt{1010 ---- --------}\\
\addlinespace[10pt]
\textbf{B} & \texttt{CMP [M], --} & Modos direccionamiento: destino memoria & \texttt{1011 ---- -------- --------}\\
\addlinespace[10pt]
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      La ejecución ocupa un paso y puede ser:
...
\hypertarget{modulo-de-entradasalida}{%
\section{Modulo de Entrada/Salida}\label{modulo-de-entradasalida}}
...
\subsubsection{Llamadas al sistema}\label{llamadas-al-sistema}}
...
El contenido de estas rutinas se encuentran almacenadas en el monitor del sistema en las direcciones \texttt{A0h}, \texttt{B0h} y \texttt{C0h} respectivamente.
...
Para la comunicacion con los modulos de entrada/salida se utilizan puertos, que son direcciones especiales en el espacio de direcciones del procesador. En este simulador, se implementan dos instrucciones para manejar la comunicación con los puertos:
- \texttt{OUT\ puerto,\ AL}: Esta instrucción envía el contenido del registro \texttt{AL} al puerto especificado. El puerto es una dirección de 8 bits, lo que permite un total de 256 puertos diferentes (de \texttt{00h} a \texttt{FFh}). Esta instrucción se utiliza para enviar datos a dispositivos externos, como impresoras o pantallas.
- \texttt{IN\ AL,\ puerto}: Esta instrucción recibe un byte desde el puerto especificado y lo almacena en el registro \texttt{AL}. Al igual que la instrucción \texttt{OUT}, el puerto es una dirección de 8 bits.
...
La memoria de entrada/salida se encuentra aislada de la memoria principal. Es decir, para acceder a ella se utilizan exclusivamente las instrucciones {[}\texttt{IN}{]} y {[}\texttt{OUT}{]}). Cuando se quiere acceder a un módulo de entrada/salida, la {[}CPU{]} activa la señal \texttt{IO/M}, lo que causa que un selector de chips (\emph{chip select}) lea la dirección del bus del direcciones y envíe la señal de lectura/escritura al módulo correspondiente.

El rango de direcciones de la memoria de entrada/salida es de \texttt{00h} hasta \texttt{FFh} (256 direcciones).
...
\bottomrule\noalign{}
\endlastfoot
\texttt{10h} & \texttt{CONT} & {[}Timer{]} \\
\texttt{11h} & \texttt{COMP} & {[}Timer{]} \\
\texttt{20h} & \texttt{EOI} & {[}PIC{]} \\
\texttt{21h} & \texttt{IMR} & {[}PIC{]} \\
\texttt{22h} & \texttt{IRR} & {[}PIC{]} \\
\texttt{23h} & \texttt{ISR} & {[}PIC{]} \\
\texttt{24h} & \texttt{INT0} & {[}PIC{]} \\
\texttt{25h} & \texttt{INT1} & {[}PIC{]} \\
\texttt{26h} & \texttt{INT2} & {[}PIC{]} \\
\texttt{27h} & \texttt{INT3} & {[}PIC{]} \\
\texttt{28h} & \texttt{INT4} & {[}PIC{]} \\
\texttt{29h} & \texttt{INT5} & {[}PIC{]} \\
\texttt{2Ah} & \texttt{INT6} & {[}PIC{]} \\
\texttt{2Bh} & \texttt{INT7} & {[}PIC{]} \\
\texttt{30h} & \texttt{PA} & {[}PIO{]} \\
\texttt{31h} & \texttt{PB} & {[}PIO{]} \\
\texttt{32h} & \texttt{CA} & {[}PIO{]} \\
\texttt{33h} & \texttt{CB} & {[}PIO{]} \\
\texttt{40h} & \texttt{DATA} & {[}Handshake{]} \\
\texttt{41h} & \texttt{STATE} & {[}Handshake{]} \\
\end{longtable}

\hypertarget{llaves-y-luces}{%
\subsection{Llaves y luces}\label{llaves-y-luces}}
...
Actualmente el codigo de operacion de las instrucciones son 4 bits, esto reduce a complejidad del simulador y el numero de instrucciones que se pueden implementar, para no tener que ampliar el tamaño de las instrucciones, pero poder mostrar más instrucciones, por ejemplo logicas y aritmeticas de 1 operando, se implementaron instrucciones con el codigo de operacion 15, entonces las instrucciones logicas con código operación 15 (AND, OR y XOR) tienen los mismos modos de direccionamiento que las instrucciones aritméticas (ADD, SUB y CMP) pero comparten el mismo código de operación.

\begin{table}[!h]
\centering
\caption{\label{tab:tisa}Categorías de instrucciones y códigos de operación en VonSim8}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{10}{12}\selectfont
...
\addlinespace[10pt]
\textbf{Control de flujo} & JMP / Jxx / CALL / INT & {12} & Salto incondicional JMP, condicionales Jxx, llamada CALL, INT: llamar rutina de interrupción\\
\addlinespace[10pt]
\addlinespace
\textbf{Gestión de flujo} & RET / IRET / CLI / STI / HLT & {13} & RET: retorno, IRET: retornar de interrupción, NOP: no opera, HLT: detiene el CPU\\
\addlinespace[10pt]
\textbf{Manejo de pila y E/S} & PUSH / POP / OUT / IN & {14} & PUSH: poner en la pila, POP: retirar de la pila, OUT: enviar a puerto, IN: recibir desde puerto\\
\addlinespace[10pt]
\textbf{Miscelánea} & AND / OR / XOR / NOT / INC / DEC & {15} & Operaciones lógicas y aritméticas\\
\addlinespace[10pt]
\bottomrule
\end{tabular}}
\end{table}
...
\item
  ...
  \item
    ...
    \item
      \textbf{\texttt{MBR} \(\leftarrow\) \texttt{read(Memoria{[}MAR{]})} \textbar{} \texttt{IP} \(\leftarrow\) \texttt{IP} + 1} -- Leer la dirección e incrementar IP.
    \item
      \texttt{ri} \(\leftarrow\) \texttt{MBR}; \texttt{SP} \(\leftarrow\) \texttt{SP} - 1
    \item
      \texttt{MAR} \(\leftarrow\) \texttt{SP}
    \item
      \texttt{MBR} \(\leftarrow\) \texttt{IP}
    \item
      \texttt{write(Memoria{[}MAR{]})} \(\leftarrow\) \texttt{MBR}
    \item
      \texttt{IP} \(\leftarrow\) \texttt{ri}
    \end{enumerate}
  \item
    \textbf{RET}
    ...
    \item
      \texttt{MAR} \(\leftarrow\) \texttt{SP}
    \item
      \texttt{MBR} \(\leftarrow\) \texttt{read(Memoria{[}MAR{]})}
    \item
      \texttt{IP} \(\leftarrow\) \texttt{MBR}
    \item
      \texttt{SP} \(\leftarrow\) \texttt{SP} + 1
    \end{enumerate}
  \end{itemize}
\item
  ...
  \item
    ...
    \item
      \texttt{MBR} \(\leftarrow\) \texttt{read(Memoria{[}MAR{]})}
    \item
      \texttt{IP} \(\leftarrow\) \texttt{MBR}; \texttt{SP} \(\leftarrow\) \texttt{SP} + 1
    \end{enumerate}
  \end{itemize}
\end{itemize}

\hypertarget{principales-caracteruxedsticas-tecnoluxf3gicas-1}{%
\section{Principales características tecnológicas}\label{principales-caracteruxedsticas-tecnoluxf3gicas-1}}
...
\hypertarget{arquitectura-modular-y-educativa}{%
\subsection{Arquitectura modular y educativa}\label{arquitectura-modular-y-educativa}}
...
\hypertarget{simulaciuxf3n-fiel-de-arquitectura-de-computadoras}{%
\subsection{Simulación fiel de arquitectura de computadoras}\label{simulaciuxf3n-fiel-de-arquitectura-de-computadoras}}
...
\hypertarget{visualizaciuxf3n-y-experiencia-de-usuario}{%
\subsection{Visualización y experiencia de usuario}\label{visualizaciuxf3n-y-experiencia-de-usuario}}
...
\hypertarget{documentaciuxf3n-y-recursos}{%
\subsection{Documentación y recursos}\label{documentaciuxf3n-y-recursos}}
...
\hypertarget{accesibilidad-y-buenas-pruxe1cticas}{%
\subsection{Accesibilidad y buenas prácticas}\label{accesibilidad-y-buenas-pruxe1cticas}}
...
VonSim8 se consolida como una herramienta educativa robusta y moderna, que combina simulación fiel, interactividad y accesibilidad, facilitando el aprendizaje profundo de los fundamentos de la arquitectura de computadoras.
