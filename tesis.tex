...
\midrule
Transferencia y procesamiento & A: entre registros & \_\_\_\_XXYY & XX = Registro destino\textbackslash{}newline YY = Registro fuente\\
 & B: Cargar a registro & \_\_\_\_XX00 MMMMMMMM & XX = Registro destino\textbackslash{}newline M = Dirección de memoria o Dato Inmediato\\
 & C: Almacenar en memoria & \_\_\_\_00YY MMMMMMMM & YY = Registro fuente\textbackslash{}newline `M` = Dirección de memoria\textbackslash{}newline `d` = Dato Inmediato\\
\midrule
Control & D: control de flujo & \_\_\_\_ffff MMMMMMMM & ffff = funcionalidad\textbackslash{}newline M = Dirección de memoria\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{longtable}[]{@{}llr@{}}
\toprule
Registros (R) & Binario & Decimal\tabularnewline
\midrule
\endhead
