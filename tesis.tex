...
\renewcommand{\maketitle}{%
  ...
  \begin{titlepage}
    \begin{center}
      \includegraphics[scale=0.25]{images/uner.png} % Logo de la universidad
      \vspace{1cm}
      {\Large \textbf{\@title}} % Título de la tesis
      \vspace{1cm}
      \textbf{\@degree} \\ % Grado
      \textbf{\@institution} \\ % Institución
      \vspace{1cm}
      \textbf{Autor: \@author}
      \vspace{1cm}
      \textbf{Director: \@advisor}
      \vspace{1cm}
      \@date
    \end{center}
  \end{titlepage}
