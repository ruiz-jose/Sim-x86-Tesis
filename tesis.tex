...
En el simulador, se optó por emplear únicamente la parte baja de cada registro, en lugar de utilizar registros de 16 bits completos. Esta decisión pedagógica simplifica tanto la representación como la manipulación de los datos, facilitando la comprensión de los conceptos fundamentales de la arquitectura de computadoras. Asimismo, se ha unificado el criterio de diseño de los registros, dotándolos de una entrada y una salida independientes, lo que permite visualizar de manera más clara la transferencia de datos entre los registros y la Unidad Aritmético-Lógica (ALU). Esta modificación resulta esencial para comprender el flujo de datos durante el ciclo de instrucción y la interacción entre los distintos componentes del procesador.
...
{\centering \includegraphics[width=0.9\linewidth]{images/registros} 
...
{\centering \includegraphics[width=0.25\linewidth]{images/idrisp} 
...
\item
  ...
  Una línea de mejora fundamental consiste en complementar la evaluación basada en percepciones con estudios empíricos que permitan analizar el desempeño académico de los estudiantes de manera objetiva. Para ello, se propone diseñar y aplicar instrumentos de evaluación cuantitativa ---como pruebas específicas o ejercicios estandarizados--- antes y después del uso del simulador, así como comparar los resultados obtenidos con los de grupos de control. Este enfoque posibilitaría cuantificar el impacto de la herramienta en la adquisición de conocimientos y habilidades, aportando evidencia más sólida sobre su eficacia pedagógica y facilitando la identificación de oportunidades de mejora.
\end{enumerate}
