...
Para comprender las arquitecturas modernas, es fundamental conocer dos modelos históricos que sentaron las bases del diseño actual de sistemas: \textbf{Von Neumann} y \textbf{Harvard}. Estos dos paradigmas son esenciales para comprender las diferencias y ventajas de las arquitecturas contemporáneas.

\hypertarget{arquitectura-von-neumann}{%
\subsection{Arquitectura Von Neumann}\label{arquitectura-von-neumann}}

La \textbf{arquitectura Von Neumann}, formulada por John von Neumann en 1945, utiliza un único espacio de memoria para almacenar tanto los datos como las instrucciones, y un solo bus para transferir ambos tipos de información. Este diseño ha sido ampliamente adoptado debido a su simplicidad, pero introduce limitaciones como el ``cuello de botella de Von Neumann'', donde el bus único se convierte en un factor limitante para la velocidad de procesamiento. Este fenómeno es especialmente relevante en sistemas donde el acceso simultáneo a datos e instrucciones es crítico. Aunque la arquitectura Von Neumann sigue siendo la base de muchas computadoras actuales, se han implementado diversas optimizaciones para mejorar su rendimiento en sistemas modernos {[}\protect\hyperlink{ref-hennessy_computer_2012}{13}{]}, {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}.

\hypertarget{arquitectura-harvard}{%
\subsection{Arquitectura Harvard}\label{arquitectura-harvard}}

Por otro lado, la \textbf{arquitectura Harvard} separa físicamente las memorias de datos y de instrucciones, permitiendo que el procesador acceda a ambas de manera simultánea. Este enfoque ofrece un rendimiento más eficiente al eliminar el cuello de botella de Von Neumann, siendo particularmente útil en sistemas embebidos y aplicaciones que requieren un alto rendimiento, como los procesadores de señal digital (DSP) {[}\protect\hyperlink{ref-tanenbaum_structured_2013}{24}{]}.
...
Aunque la arquitectura Von Neumann sigue siendo ampliamente utilizada debido a su simplicidad y flexibilidad, la arquitectura Harvard ha ganado popularidad en sistemas donde la eficiencia y la velocidad son primordiales, como en dispositivos móviles y sistemas de tiempo real. Hoy en día, muchas arquitecturas modernas, como \textbf{x86}, \textbf{ARM} y \textbf{RISC-V}, adoptan una combinación de ambos modelos, Von Neumann y Harvard, para maximizar tanto el rendimiento como la eficiencia energética {[}\protect\hyperlink{ref-null_essentials_2014}{22}{]}.

Esta integración de ambos enfoques permite a los diseñadores aprovechar lo mejor de cada arquitectura según las necesidades de la aplicación, optimizando la transferencia de datos y la ejecución de instrucciones. Esta dicotomía entre las dos arquitecturas sigue siendo un aspecto fundamental en la evolución de los sistemas modernos, donde se priorizan tanto el rendimiento como la eficiencia.
...
Las arquitecturas de repertorio de instrucciones son componentes cruciales en el diseño de procesadores. Dos de las filosofías de diseño más influyentes en este ámbito son \textbf{CISC (Complex Instruction Set Computing)} y \textbf{RISC (Reduced Instruction Set Computing)}. Mientras que CISC busca reducir la cantidad de instrucciones necesarias para realizar una tarea compleja, RISC simplifica el conjunto de instrucciones para optimizar la velocidad y la eficiencia energética. En esta sección se exploran estos dos enfoques y sus implicaciones en el diseño de procesadores {[}\protect\hyperlink{ref-hennessy_computer_2012}{13}{]}, {[}\protect\hyperlink{ref-patterson_computer_2014}{23}{]}.
...
\hypertarget{impacto-del-formato-de-instrucciones-entre-cisc-y-risc}{%
\subsection{Impacto del formato de instrucciones entre CISC y RISC}\label{impacto-del-formato-de-instrucciones-entre-cisc-y-risc}}
...
\hypertarget{ejemplos-pruxe1cticos-de-modos-de-direccionamiento-entre-cisc-y-risc}{%
\subsection{Ejemplos prácticos de modos de direccionamiento entre CISC y RISC}\label{ejemplos-pruxe1cticos-de-modos-de-direccionamiento-entre-cisc-y-risc}}

Los \textbf{modos de direccionamiento} permiten a los procesadores acceder a datos de manera eficiente y flexible {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}. A continuación se incluyen ejemplos prácticos de cómo estos modos se utilizan en las arquitecturas \textbf{x86}, \textbf{ARM} y \textbf{MIPS}, y cómo afectan el rendimiento.

\hypertarget{modo-inmediato-vs.-indirecto}{%
\subsubsection{Modo inmediato vs.~indirecto}\label{modo-inmediato-vs.-indirecto}}

En el modo de \textbf{direccionamiento inmediato}, el valor del operando está incrustado directamente en la instrucción, lo que permite un acceso rápido y eficiente. Por ejemplo, en ARM, este modo es común para operaciones aritméticas simples, donde se requiere velocidad en lugar de flexibilidad.
...
\begin{longtable}[]{@{}lll@{}}
\caption{\label{tab:comparativaciscrisc}Comparativa entre CISC y RISC}\tabularnewline
\toprule
...
Objetivo principal\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Minimizar el número de instrucciones para operaciones complejas\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Simplificar el conjunto de instrucciones para optimizar velocidad y eficiencia energética\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\raggedright
Tipo de instrucciones\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Instrucciones complejas, longitud variable\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Instrucciones simples, longitud fija\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\raggedright
Decodificación y ejecución\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Requiere hardware más complejo, posibles cuellos de botella en el pipeline\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Decodificación más sencilla, facilita el uso de técnicas avanzadas como pipelining\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\raggedright
Longitud de instrucciones\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Longitud variable, puede aumentar el tiempo de decodificación\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Longitud fija, simplifica la decodificación y mejora la predictibilidad del rendimiento\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\raggedright
Eficiencia energética\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Menor eficiencia energética en comparación con RISC\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Mayor eficiencia energética, especialmente en dispositivos móviles\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\raggedright
Modos de direccionamiento\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Flexibilidad a costa de mayor latencia\strut
\end{minipage} & \begin{minipage}[t]{0.43\columnwidth}\raggedright
Acceso más rápido a los operandos, menor latencia\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\hypertarget{ensambladores-x86-1}{%
\subsubsection{Ensambladores x86}\label{ensambladores-x86-1}}

\begin{table}

\caption{\label{tab:tablaevolucionx86}Comparativa de Ensambladores x86}
\centering
...
Según Banks {[}\protect\hyperlink{ref-banks_discrete-event_2010}{2}{]}, la simulación se define como el proceso de replicar el comportamiento de un sistema a lo largo del tiempo mediante la creación de un modelo conceptual que refleje sus características y dinámicas. Este modelo simulado evoluciona con el tiempo, proporcionando una representación detallada de cómo se desarrolla el sistema real {[}\protect\hyperlink{ref-banks_discrete-event_2010}{2}{]}{[}\protect\hyperlink{ref-robinson_simulation_2014}{4}{]}.

La capacidad de replicar y analizar sistemas complejos sin necesidad de intervención directa convierte a la simulación en una metodología indispensable para ingenieros, diseñadores y gerentes en el entorno digital actual. Permite evaluar el rendimiento de sistemas, prever su comportamiento en diferentes escenarios y optimizar su diseño antes de su implementación. Con los avances tecnológicos, la simulación se ha consolidado como una herramienta crucial para ingenieros, docentes, diseñadores y gerentes, debido a que la complejidad intrínseca de los sistemas informáticos dificulta su comprensión y encarece su desarrollo sin técnicas de simulación {[}\protect\hyperlink{ref-law_simulation_2015}{3}{]}{[}\protect\hyperlink{ref-zeigler_theory_2000}{20}{]}.
...
En resumen, la simulación no solo mejora la comprensión de los estudiantes, sino que también fomenta la experimentación y promueve un aprendizaje más activo y participativo.{[}\protect\hyperlink{ref-lion_simuladores_2005}{5}{]}.

\hypertarget{simulaciuxf3n-aplicada-a-la-asignatura-arquitectura-de-computadoras}{%
\subsection{Simulación aplicada a la asignatura Arquitectura de Computadoras}\label{simulaciuxf3n-aplicada-a-la-asignatura-arquitectura-de-computadoras}}

La asignatura \textbf{Arquitectura de Computadoras} de la carrera Licenciatura en Sistemas tiene por objetivos:
