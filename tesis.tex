...
La disciplina de arquitectura de computadoras constituye un pilar central en la informática, enfocada en el diseño y la organización de los componentes que conforman un sistema computacional. Esta área abarca tanto el hardware como el software, y su comprensión es esencial para el desarrollo de sistemas eficientes y potentes. La arquitectura de computadoras no solo alude a la estructura física de los componentes, sino también a la forma en que interactúan entre ellos y con el software \protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}, \protect\hyperlink{ref-tanenbaum_structured_2013}{{[}22{]}}, \protect\hyperlink{ref-murdocca_principles_2000}{{[}23{]}}, \protect\hyperlink{ref-bryant2015computer}{{[}24{]}}.

Es importante diferenciar entre \textbf{arquitectura de computadoras}, que describe los componentes funcionales visibles al programador, y \textbf{organización de computadoras}, que se refiere a la implementación física de dichos componentes. Esta última considera cómo se estructuran y coordinan elementos del hardware, como las unidades de procesamiento, la memoria y las señales de control, con el fin de cumplir los objetivos de rendimiento y funcionalidad \protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}, \protect\hyperlink{ref-tanenbaum_structured_2013}{{[}22{]}}, \protect\hyperlink{ref-murdocca_principles_2000}{{[}23{]}}. La arquitectura de computadoras abarca el diseño de elementos como el conjunto de instrucciones, la organización de la memoria y los mecanismos de entrada/salida. Estos elementos inciden directamente en el rendimiento y la eficiencia del sistema, lo cual resulta crucial para el desarrollo de tecnologías emergentes, como sistemas de bajo consumo, computación en la nube o dispositivos embebidos. \protect\hyperlink{ref-hennessy_computer_2012}{{[}13{]}}, \protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}, \protect\hyperlink{ref-tanenbaum_structured_2013}{{[}22{]}}, \protect\hyperlink{ref-murdocca_principles_2000}{{[}23{]}}, \protect\hyperlink{ref-bryant2015computer}{{[}24{]}}.

La arquitectura de computadoras evoluciona constantemente para mejorar rendimiento y eficiencia energética \protect\hyperlink{ref-hennessy_computer_2012}{{[}13{]}}. Este desarrollo ha generado arquitecturas especializadas como ARM y RISC-V, ideales para dispositivos móviles y sistemas embebidos \protect\hyperlink{ref-waterman_risc-v_2014}{{[}25{]}}, \protect\hyperlink{ref-harris2015digital}{{[}26{]}}, \protect\hyperlink{ref-null_essentials_2014}{{[}27{]}}.

Una comprensión integral de la arquitectura de computadoras requiere analizar atributos clave como el repertorio de instrucciones (por ejemplo, x86 o ARM), la capacidad de procesamiento (32 o 64 bits), las técnicas de direccionamiento de memoria (directo o segmentado), la jerarquía de memoria y los mecanismos de entrada y salida \protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}, \protect\hyperlink{ref-bryant2015computer}{{[}24{]}}, \protect\hyperlink{ref-null_essentials_2014}{{[}27{]}}. También son relevantes aspectos como el paralelismo y la eficiencia energética, los cuales resultan fundamentales tanto para mejorar el rendimiento del hardware como para optimizar el desarrollo de software y sistemas operativos contemporáneos \protect\hyperlink{ref-hennessy_computer_2012}{{[}13{]}}, \protect\hyperlink{ref-patterson_computer_2014}{{[}28{]}}.

El estudio de la arquitectura de computadoras no solo brinda herramientas para comprender el funcionamiento interno de los sistemas informáticos, sino que también facilita su adaptación y optimización frente a las exigencias de nuevas tendencias tecnológicas como la computación en la nube, la inteligencia artificial y el internet de las cosas {[}\protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}; \protect\hyperlink{ref-tanenbaum_structured_2013}{{[}22{]}}; \protect\hyperlink{ref-patterson2016computer}{{[}29{]}}; belli2020iot{]}.

En síntesis, la arquitectura de computadoras constituye una disciplina estratégica que habilita la comprensión profunda de los sistemas informáticos y su adaptación a nuevos contextos tecnológicos. Su estudio es fundamental para abordar desafíos en ámbitos como la inteligencia artificial, la ciberseguridad o el desarrollo de sistemas embebidos. Este conocimiento habilita la resolución de desafíos tecnológicos emergentes y potencia la inserción profesional en sectores que demandan competencias en diseño y optimización de sistemas complejos \protect\hyperlink{ref-stallings_computer_2013}{{[}14{]}}, \protect\hyperlink{ref-harris2015digital}{{[}26{]}}, \protect\hyperlink{ref-patterson2016computer}{{[}29{]}}.
...
En el caso de la arquitectura x86, los programadores pueden elegir entre diversos ensambladores, como TASM (Turbo Assembler) \protect\hyperlink{ref-tasm}{{[}31{]}}, MASM (Microsoft Macro Assembler) \protect\hyperlink{ref-masm}{{[}32{]}} y NASM (Netwide Assembler) \protect\hyperlink{ref-nasm}{{[}33{]}}. Aunque cada ensamblador tiene características y sintaxis particulares, todos comparten el objetivo fundamental de convertir las instrucciones ensamblador en código binario ejecutable por los procesadores x86 \protect\hyperlink{ref-hyde2010art}{{[}34{]}}.
...
Estas características transforman la experiencia de aprendizaje, al vincular teoría con práctica y promover un enfoque activo en la comprensión de conceptos clave de arquitectura de computadoras. Al adoptar DEVS como parte del entorno educativo, se potencia la capacidad de los estudiantes para abordar problemas complejos y explorar soluciones innovadoras \protect\hyperlink{ref-calvo_valdes_simulador_2010}{{[}37{]}}.
...
Este análisis comparativo fue publicado en el XVII Congreso de Tecnología en Educación y Educación en Tecnología (2022), bajo el título ``Herramientas de software para dar soporte en la enseñanza y aprendizaje de la arquitectura x86''\protect\hyperlink{ref-colombani_herramientas_2022}{{[}38{]}}.
...
\leavevmode\vadjust pre{\hypertarget{ref-stallings_computer_2013}{}}%
\CSLLeftMargin{{[}14{]} }%
