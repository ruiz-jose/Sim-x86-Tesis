...
Esta etapa es igual para todas las instrucciones. Su objetivo es leer la instrucción desde la memoria. Consta de tres microoperaciones:
...
\item
  ...
  El contenido del \texttt{MBR} se transfiere al \textbf{Registro de Instrucciones} (\texttt{IR}). A partir de este momento, la instrucción está lista para ejecutarse.
\end{enumerate}

\hypertarget{etapa-2-ejecuciuxf3n}{%
\subsection{Etapa 2: Ejecución:}\label{etapa-2-ejecuciuxf3n}}

En esta etapa, las operaciones dependen del tipo de instrucción. A continuación se explican los casos más comunes.
