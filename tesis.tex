...
Cuando el programa tiene instrucciones INT o de manejo de pila se resalta en memoria el el vector de interrucciones, 8 posiciones de memoria desde \texttt{0x00} a \texttt{0x07} y la dirección apuntada por el registro SP:
...
\section{Principales características tecnológicas}\label{principales-caracteruxedsticas-tecnoluxf3gicas}}
