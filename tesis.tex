...
Para cumplir con este objetivo, se definieron una serie de requisitos funcionales y pedagógicos que estructuran el diseño, validación y desarrollo del simulador. Estos requisitos se alinean con los objetivos educativos presentados en el capítulo introductorio y responden a las limitaciones identificadas en el análisis de simuladores existentes.
...
Esta sección detalla los requisitos funcionales y pedagógicos que guiaron el diseño del simulador, en base a los objetivos didácticos establecidos en el capítulo introductorio (\ref{intro}). Su definición se apoyó en principios pedagógicos y técnicos, y se complementó con una validación empírica basada en entrevistas semiestructuradas a docentes expertos. Este proceso permitió identificar necesidades concretas del aula, así como carencias en las herramientas existentes (ver Anexo A \protect\hyperlink{ref-ref}{\textbf{ref?}}(anexoA)). Este tipo de diseño guiado por entrevistas cualitativas permite captar las necesidades auténticas del aula y fundamentar técnicamente los requerimientos de desarrollo \protect\hyperlink{ref-huberman2019qualitative}{\textbf{huberman2019qualitative?}}.
...
\tightlist
\item
  Permitir la ejecución paso a paso y la ejecución completa de programas escritos en lenguaje ensamblador. Esta funcionalidad permite un análisis detallado del comportamiento de cada instrucción, promoviendo el desarrollo de competencias en el trazado y depuración de código a nivel de lenguaje ensamblador, lo cual resulta esencial para interiorizar la relación entre software y hardware.
\end{itemize}
...
\begin{tabular}[t]{>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{6cm}>{\centering\arraybackslash}p{6cm}}
\toprule
\multicolumn{1}{>{\centering\arraybackslash}p{3cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Fase}}} & \multicolumn{1}{>{\centering\arraybackslash}p{6cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Instrucciones activadas}}} & \multicolumn{1}{>{\centering\arraybackslash}p{6cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Objetivo didáctico}}}\\
\midrule
...
Además de las funcionalidades asociadas al repertorio de instrucciones, resulta fundamental representar visualmente el flujo interno de datos dentro del procesador para facilitar la comprensión de operaciones a nivel microarquitectónico.
...
\tightlist
\item
  Incluir indicadores clave como tiempo de ciclo, tiempo de CPU y ciclos por instrucción (CPI), generados automáticamente a partir de la ejecución de los programas. Estos indicadores se presentan en una interfaz específica que facilita su análisis y comprensión. Su inclusión responde a la necesidad de fomentar habilidades analíticas vinculadas al rendimiento computacional. Como señalan Hennessy y Patterson \protect\hyperlink{ref-hennessy2017computer}{{[}13{]}} esta funcionalidad permite a los estudiantes familiarizarse con conceptos fundamentales del análisis de desempeño, utilizados tanto en contextos académicos como en la industria, fomentando una formación técnica integral.
\end{itemize}
...
\tightlist
\item
  \textbf{Interfaz gráfica intuitiva y amigable:}
\end{enumerate}

\begin{itemize}
\tightlist
\item
  Diseñar una interfaz gráfica intuitiva y adaptable a diferentes dispositivos y niveles de experiencia del usuario. La interfaz debe contemplar principios de accesibilidad para personas con diversidad funcional, con opciones de contraste visual, navegación por teclado y descripciones accesibles. Esto responde a estándares actuales de desarrollo de software educativo y mejora la inclusión en entornos de enseñanza \protect\hyperlink{ref-w3c_accessibility_2021}{{[}63{]}}.
\end{itemize}
...
Como complemento a la tabla de requisitos funcionales, se incorpora un diagrama estructural que presenta los principales módulos del simulador y sus interacciones. Esta representación permite integrar visualmente los componentes implementados y su relación con los objetivos funcionales definidos.
...
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{>{\centering\arraybackslash}p{6cm}|>{\centering\arraybackslash}p{9cm}}
\toprule
\multicolumn{1}{>{\centering\arraybackslash}p{6cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Requisito didáctico}}} & \multicolumn{1}{>{\centering\arraybackslash}p{9cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Beneficio pedagógico esperado}}}\\
\midrule
\textbf{Ejecución paso a paso} & Favorece la comprensión secuencial de las instrucciones\\
\addlinespace[10pt]
\textbf{Habilitación progresiva del repertorio} & Reduce la carga cognitiva y promueve aprendizaje incremental\\
\addlinespace[10pt]
\textbf{Visualización de ciclos de instrucción (RTL)} & Facilita el aprendizaje del funcionamiento interno del procesador\\
\addlinespace[10pt]
\bottomrule
\end{tabular}}
\end{table}
...
Para el diseño del simulador desarrollado en este trabajo, se tomó como referencia el simulador VonSim\footnote{VonSim: \url{https://vonsim.github.io/}}, una herramienta educativa basada en la arquitectura de Von Neumann que permite visualizar y experimentar el ciclo de instrucción de una manera interactiva. Esta herramienta sirvió como base conceptual y funcional debido a su enfoque didáctico y su estructura visual clara, orientada a la enseñanza de principios fundamentales de arquitectura de computadoras \protect\hyperlink{ref-vonsim}{{[}69{]}}.
...
\begin{tabular}[t]{>{\centering\arraybackslash}p{4cm}|>{\centering\arraybackslash}p{5.5cm}>{\centering\arraybackslash}p{5.5cm}}
\toprule
\multicolumn{1}{>{\centering\arraybackslash}p{4cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{Característica}}} & \multicolumn{1}{>{\centering\arraybackslash}p{5.5cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{VonSim}}} & \multicolumn{1}{>{\centering\arraybackslash}p{5.5cm}}{\cellcolor[HTML]{D3D3D3}{\textbf{VonSim8}}}\\
\midrule
\textbf{Arquitectura} & Von Neumann & Von Neumann\\
\addlinespace[10pt]
\textbf{Tamaño de registros} & Variable según versión & 8 bits\\
\addlinespace[10pt]
\textbf{Interfaz gráfica} & Completa, detallada & Simplificada, esquemática\\
\addlinespace[10pt]
\textbf{Repertorio de instrucciones} & Amplio & Reducido y adaptado\\
\addlinespace[10pt]
\textbf{Objetivo didáctico} & Demostración de conceptos avanzados & Comprensión progresiva de conceptos básicos\\
\addlinespace[10pt]
\bottomrule
\end{tabular}}
\end{table}
...
\begin{table}[!h]
\centering
\caption{\label{tab:arq}Componentes del CPU VonSim8}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{9cm}}
...
\addlinespace[10pt]
\addlinespace
\textbf{Memoria} & Capacidad de direccionamiento de 256 posiciones, cada una de byte.\\
\addlinespace[10pt]
...
\addlinespace[8pt]
\textbf{Pocesamiento de datos} & ADD & Sumar\\
\addlinespace[8pt]
\textbf{} & SUB & Restar\\
\addlinespace[8pt]
\textbf{} & CMP & Comparar\\
