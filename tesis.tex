...
& - 4 registros de propósito general, \texttt{AL}, \texttt{BL}, \texttt{DL} y \texttt{DL}.\tabularnewline
...
\midrule
\endhead
A & \texttt{OOOO\ XXYY} & \texttt{XX} = Registro destino, \texttt{YY} = Registro fuente\tabularnewline
B & \texttt{OOOO\ XXmm\ DDDDDDDD} & \texttt{XX} = Registro destino\tabularnewline
...
\tightlist
\item
  \texttt{Rx} o \texttt{Ry}: Índices de registros, número entre \texttt{0} y \texttt{3}.
\item
