...
La arquitectura ARM es conocida por su alta eficiencia energética, lo que la ha hecho muy popular en dispositivos móviles, como smartphones y tablets, y en sistemas embebidos. ARM utiliza un conjunto de instrucciones reducido (RISC), lo que simplifica el diseño del hardware y reduce el consumo de energía. Aunque su rendimiento es moderado en comparación con x86, la arquitectura ARM es ideal para aplicaciones donde la eficiencia energética es crucial {[}\protect\hyperlink{ref-patterson_computer_2014}{23}{]}.
...
\item
  \textbf{Formato de las Instrucciones}: La estructura de una instrucción determina la longitud, el número de operandos y los modos de direccionamiento. Esto tiene un impacto directo en la eficiencia y la complejidad del procesador.
\item
  \textbf{Modos de Direccionamiento}: Definen cómo se especifican los operandos en las instrucciones. Modos comunes incluyen inmediato, directo, indirecto y relativo. Cada uno ofrece diferentes ventajas en términos de flexibilidad y eficiencia.
\end{itemize}
...
El repertorio de instrucciones no solo define qué operaciones puede realizar un procesador, sino también cómo se organizan y ejecutan {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}. Las funciones principales incluyen:

\begin{itemize}
\item
  \textbf{Control de la CPU}: Instrucciones de control que gestionan la secuencia de ejecución, interrupciones y llamadas a subrutinas.
\item
  \textbf{Interacción con la Memoria}: Las instrucciones permiten que la CPU cargue y almacene datos desde y hacia la memoria principal, aspecto crítico para la ejecución de programas.
\item
  \textbf{Gestión de Datos}: Las operaciones aritméticas, lógicas y de comparación son esenciales para la manipulación de datos. El diseño adecuado del repertorio puede simplificar y acelerar estas operaciones.
\item
  \textbf{Optimización del Rendimiento}: Un repertorio de instrucciones eficiente minimiza el número de instrucciones para completar una tarea, mejorando el uso de energía y los recursos del sistema {[}\protect\hyperlink{ref-hennessy_computer_2012}{13}{]}.
\end{itemize}
...
{\centering \includegraphics[width=1\linewidth]{images/modosdireccionamiento} 

}

\caption{Modos de direccionamiento}\label{fig:flujo}
\end{figure}

\hypertarget{formato-de-las-instrucciones}{%
\subsection{Formato de las Instrucciones}\label{formato-de-las-instrucciones}}

El formato de las instrucciones determina cómo se estructuran las instrucciones en términos de longitud, número de operandos y campos adicionales como el código de operación (\textbf{opcode}){\textbf{???}}, {[}\protect\hyperlink{ref-hennessy_computer_2012}{13}{]}. El formato tiene un impacto directo en la complejidad del diseño del procesador:
...
\hypertarget{cisc-reducciuxf3n-de-instrucciones-aumento-de-complejidad}{%
\subsection{CISC: Reducción de Instrucciones, Aumento de Complejidad}\label{cisc-reducciuxf3n-de-instrucciones-aumento-de-complejidad}}
...
\hypertarget{risc-simplicidad-para-mayor-velocidad-y-eficiencia-energuxe9tica}{%
\subsection{RISC: Simplicidad para Mayor Velocidad y Eficiencia Energética}\label{risc-simplicidad-para-mayor-velocidad-y-eficiencia-energuxe9tica}}
...
\hypertarget{impacto-del-formato-de-instrucciones-en-el-rendimiento}{%
\section{Impacto del Formato de Instrucciones en el Rendimiento}\label{impacto-del-formato-de-instrucciones-en-el-rendimiento}}

Una de las diferencias clave entre CISC y RISC radica en el formato de las instrucciones. En \emph{Structured Computer Organization} de Tanenbaum se detalla cómo el \textbf{formato de longitud fija}, característico de las arquitecturas RISC, simplifica la \textbf{decodificación} y mejora el rendimiento general del procesador {[}\protect\hyperlink{ref-tanenbaum_structured_2013}{24}{]}.

\hypertarget{formato-de-longitud-fija-en-risc}{%
\subsection{Formato de Longitud Fija en RISC}\label{formato-de-longitud-fija-en-risc}}
...
\hypertarget{formato-de-longitud-variable-en-cisc}{%
\subsection{Formato de Longitud Variable en CISC}\label{formato-de-longitud-variable-en-cisc}}
...
\hypertarget{ejemplos-pruxe1cticos-de-modos-de-direccionamiento}{%
\section{Ejemplos Prácticos de Modos de Direccionamiento}\label{ejemplos-pruxe1cticos-de-modos-de-direccionamiento}}

Los \textbf{modos de direccionamiento} permiten a los procesadores acceder a datos de manera eficiente y flexible. En \emph{Computer Organization and Architecture} de William Stallings, se analizan en detalle varios modos de direccionamiento, como el \textbf{inmediato}, \textbf{indirecto} y \textbf{relativo}. A continuación se incluyen ejemplos prácticos de cómo estos modos se utilizan en las arquitecturas \textbf{x86}, \textbf{ARM} y \textbf{MIPS}, y cómo afectan el rendimiento.

\hypertarget{modo-inmediato-vs.-indirecto}{%
\subsection{Modo Inmediato vs.~Indirecto}\label{modo-inmediato-vs.-indirecto}}
...
\subsection{Arquitectura x86}\label{arquitectura-x86-1}}
...
\hypertarget{repertorio-de-instrucciones-arquitectura-x86}{%
\subsection{Repertorio de instrucciones arquitectura x86}\label{repertorio-de-instrucciones-arquitectura-x86}}
...
\hypertarget{estructura-general-de-una-instrucciuxf3n-x86}{%
\paragraph{Estructura General de una Instrucción x86}\label{estructura-general-de-una-instrucciuxf3n-x86}}
...
\hypertarget{complejidad-en-la-decodificaciuxf3n}{%
\paragraph{Complejidad en la Decodificación}\label{complejidad-en-la-decodificaciuxf3n}}
...
El código fuente generado en mnemotécnicos debe ser traducido a lenguaje máquina para poder ser ejecutado por la computadora. Este proceso lo realizan programas denominados ensambladores. Dentro del contexto de la arquitectura x86, existen diversos lenguajes ensambladores como TASM (Turbo Assembler) {[}\protect\hyperlink{ref-tasm}{27}{]}, MASM (Microsoft Macro Assembler) {[}\protect\hyperlink{ref-masm}{28}{]} y NASM (Netwide Assembler) {[}\protect\hyperlink{ref-nasm}{29}{]}, cada uno con características y beneficios únicos que se adaptan a distintas necesidades y preferencias de los programadores. Estos ensambladores convierten el código simbólico en código máquina, permitiendo su ejecución en el hardware específico de la arquitectura x86 {[}\protect\hyperlink{ref-hyde2010art}{30}{]}.
...
Los resultados de esta comparativa se publicaron en el XVII Congreso de Tecnología en Educación y Educación en Tecnología en 2022, bajo el título `Herramientas de software para dar soporte en la enseñanza y aprendizaje de la arquitectura x86' {[}\protect\hyperlink{ref-colombani_herramientas_2022}{31}{]}.
...
El resultado de esta comparativa fue publicado en el XVII Congreso de Tecnología en educación y Educación en Tecnología año 2022 bajo el título de ``Herramientas de software para dar soporte en la enseñanza y aprendizaje de la arquitectura x86'' {[}\protect\hyperlink{ref-colombani_herramientas_2022}{31}{]}.
...
{[}26{]} K. R. Irvine and L. B. Das, \emph{Assembly language for x86 processors}. Prentice Hall, 2011.

\leavevmode\hypertarget{ref-tasm}{}%
{[}27{]} B. International, \emph{Turbo assembler user's guide}. Borland International, 1993.

\leavevmode\hypertarget{ref-masm}{}%
{[}28{]} M. Corporation, \emph{Microsoft macro assembler 6.1 reference}. Microsoft Press, 1992.

\leavevmode\hypertarget{ref-nasm}{}%
{[}29{]} The NASM Project, \emph{The netwide assembler (nasm) manual}. 2023.

\leavevmode\hypertarget{ref-hyde2010art}{}%
{[}30{]} R. Hyde, \emph{The art of assembly language}. No Starch Press, 2010.

\leavevmode\hypertarget{ref-colombani_herramientas_2022}{}%
{[}31{]} M. A. Colombani, J. M. Ruiz, A. G. Delduca, and M. A. Falappa, ``Herramientas de software para dar soporte en la enseñanza y aprendizaje de la arquitectura x86,'' 2022. Accessed: Jul. 10, 2024. Available: \url{http://sedici.unlp.edu.ar/handle/10915/139908}

\leavevmode\hypertarget{ref-behrooz_computer_2005}{}%
{[}32{]} P. BEHROOZ, \emph{Computer Architecture: From Microprocessors to Supercomputers}. Oxford University Press Inc, 2005.
\end{cslreferences}
