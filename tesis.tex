...
\section{Evaluación de Herramientas Existentes}\label{evaluaciuxf3n-de-herramientas-existentes}}
...
\section{Desarrollo de una Nueva Herramienta de Simulación}\label{desarrollo-de-una-nueva-herramienta-de-simulaciuxf3n}}
...
\tightlist
\item
  \textbf{Visión global de la estructura y funcionamiento de la computadora:}
  ...
  \end{itemize}
\item
  \textbf{Generación y ejecución de programas en ensamblador:}
...
\item
  ...
  \end{itemize}
\item
  \textbf{Gestión de interrupciones y comunicación con periféricos:}
  ...
  \end{itemize}
\item
  \textbf{Medidas de rendimiento de ejecución de programas:}
...
\subsection{Repertorio de instrucciones propuesto}\label{repertorio-de-instrucciones-propuesto}}
...
\end{minipage} & \begin{minipage}[t]{0.16\columnwidth}\raggedright
\textbf{+ ADD \{3, 4, 5\}}\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
Operación aritmética: operando1 \(\leftarrow\) operando1 OPE operando2; actualiza el destino.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.19\columnwidth}\raggedright
...
\section{Procesador o CPU}\label{procesador-o-cpu}}
...
\midrule
\endhead
Arquitectura & - \emph{von Neumann}, memoria de datos e instrucciones compartidas.\tabularnewline
Registros & - 4 registros de propósito general, \texttt{AL}, \texttt{BL}, \texttt{DL} y \texttt{DL} de 8 bits.\tabularnewline
& - 2 registros de propósito específico \texttt{IP} y \texttt{SP}.\tabularnewline
Memoria & - Memoria de 256 bytes.\tabularnewline
Buses & - Bus de datos y direcciones de 8 bits.\tabularnewline
Instrucciones & - Tamaño de instrucciones variable de 1, 2 y 3 bytes.\tabularnewline
& - 16 instrucciones soportadas.\tabularnewline
\bottomrule
\end{longtable}
...
B: indirecto\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{OOOO\ 00ZZ}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{ZZ} = Puede ser registro destino o fuente\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
C: directo/inmediato: dirección/dato a registro\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{OOOO\ mmZZ\ DDDDDDDD}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{mm} = modo \texttt{D} = Dirección de memoria o Dato Inmediato\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.30\columnwidth}\raggedright
D: inmediato: dato a memoria\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{OOOO\ \ mmmm\ DDDDDDDD\ DDDDDDDD}\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\texttt{D} = Dirección de memoria o Inmediato\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}

Considerando:
- \texttt{A} y \texttt{B}: son de 1 byte, \texttt{C} es de 2 bytes y \texttt{D} es de 3 bytes.
- \texttt{OOOO}: Código de operación de la instrucción.
- \texttt{XX} o \texttt{YY}: Índices de registros, número entre \texttt{0} y \texttt{3}.
- \texttt{ZZ}: Puede ser registro destino o fuente.
- \texttt{D}: Dirección de memoria o Dato inmediato, número de 8 bits.
- \texttt{m}: especifica el modo de direccionamiento.
- Las instruciones de transferencia y operaciones en la ALU soportan todos esos formatos de instrucciones.

\hypertarget{instrucciones-soportadas}{%
\subsection{Instrucciones soportadas}\label{instrucciones-soportadas}}
...
1\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ Rx,\ {[}BL{]}}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Rx} \(\leftarrow\) \texttt{Mem{[}BL{]}}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0001\ 00ZZ}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
1\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0001\ 01ZZ\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
1\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ Rx,\ D}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Rx} \(\leftarrow\) \texttt{Dato}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0001\ 10ZZ\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
1\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ Rx,\ {[}BL\ +\ D{]}}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Rx} \(\leftarrow\) \texttt{Mem{[}BL\ +\ Dato{]}}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0001\ 11ZZ\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}BL{]},\ Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}BL{]}} \(\leftarrow\) \texttt{Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 00ZZ}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}M{]},\ Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}Dirección{]}} \(\leftarrow\) \texttt{Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 01ZZ\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}M{]},\ D}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}Dirección{]}} \(\leftarrow\) \texttt{Dato}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 1000\ DDDDDDDD\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}BL{]},\ D}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}BL{]}} \(\leftarrow\) \texttt{Dato}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 1001\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}BL\ +\ D{]},\ D}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}BL\ +\ Dato{]}} \(\leftarrow\) \texttt{Dato}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 1010\ DDDDDDDD\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
2\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{MOV\ {[}BL\ +\ D{]},\ Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{Mem{[}BL\ +\ Dato{]}} \(\leftarrow\) \texttt{Rx}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0010\ 11ZZ\ DDDDDDDD}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
3\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
...
\texttt{ADD\ -\/-,\ -\/-}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
Mismo direccionamientos que MOV\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{0100\ -\/-\/-\/-\ -\/-\/-\/-\/-\/-\/-\/-}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.09\columnwidth}\raggedright
...
\texttt{Jxx\ M}\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
Se pueden implemementar más flags y CALL\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
\texttt{1100\ xxxx\ -\/-\/-\/-\/-\/-\/-\/-}\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
Podemos clasificar las instrucciones según los modos de direccionamientos que indica de donde proviene un operando:
Operando tipo
- \texttt{Rx},\texttt{Ry}: por Registros
- \texttt{{[}M{]}}: Directo, se accede a un contenido de memoria
- \texttt{D}: el operando fuente es un valor inmediato
- \texttt{{[}R{]}}: indirecto por registro, Contenido de la dirección de memoria esta dada por el registro BL
...
- Copiar entre registros - Almacenar en memoria - Cargar a registro\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.11\columnwidth}\raggedright
...
ADD \{3, 4, 5\}\strut
\end{minipage} & \begin{minipage}[t]{0.66\columnwidth}\raggedright
Operación aritmética: operando1 \textless- operando1 OPE operando2; actualiza el destino.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.11\columnwidth}\raggedright
Control de flujo\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright
JMP / Jxx / CALL / RET \{12\}\strut
\end{minipage} & \begin{minipage}[t]{0.66\columnwidth}\raggedright
Salto incondicional JMP. Saltos condicionales Jxx. Llamadas a rutinas CALL y retorno RET.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.11\columnwidth}\raggedright
