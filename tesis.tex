...
La tabla \ref{tab:microoperacioneseje} ilustra las microoperaciones que implementan esta instrucción.

\begin{table}[!h]
\centering
\caption{\label{tab:microoperacioneseje}Secuencia de microoperaciones y eventos DEVS para la Fase de Ejecución (MOV AL, BL)}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{10}{12}\selectfont
