...
Bloque & Descripción\\
\midrule
Unidad Central de Procesamiento (CPU) & Simulación de registros, Unidad de Control (UC) y ALU.\\
...
Transferencia y procesamiento & A: entre registros & \_\_\_\_XXYY & XX = Registro destino, YY = Registro fuente\\
 & B: Cargar a registro & \_\_\_\_XX00 MMMMMMMM & XX = Registro destino, M = Dirección de memoria\\
 & C: Almacenar en memoria & \_\_\_\_00YY MMMMMMMM & YY = Registro fuente, M = Dirección de memoria\\
\midrule
...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{8em}|>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{10em}}
\caption{\label{tab:isacompleta}Tabla de Instrucciones y Códigos de Operación de la Arquitectura x86}\\
\toprule
\cellcolor[HTML]{D3D3D3}{\textbf{Código operación}} & \cellcolor[HTML]{D3D3D3}{\textbf{Instrucciones}} & \cellcolor[HTML]{D3D3D3}{\textbf{nemónico}} & \cellcolor[HTML]{D3D3D3}{\textbf{Acción}}\\
\midrule
\textbf{MOV} & Transferencia de datos & MOV EAX, EBX & 1- Copiar entre registros 2- Cargar a registro 3- Almacenar en memoria\\
\textbf{ADD} & Aritmética & ADD EAX, 1 & 1- Sumar  2- Restar 3- Comparar\\
\textbf{JMP} & Control de flujo & JMP 0x00400000 & Salto incondicional JMP. Saltos condicionales Jxx.Llamadas a rutinas CALL y retorno RET\\
