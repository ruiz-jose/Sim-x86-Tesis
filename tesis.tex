...
\begin{table}
\centering
\caption{\label{tab:funcionalidadessimulador}Tabla 1. Funcionalidades principales del simulador propuesto}
\centering
...
El objetivo principal de esta tesis es desarrollar una herramienta de simulación centrada en la arquitectura x86, orientada a fortalecer los procesos de enseñanza y aprendizaje de la asignatura Arquitectura de Computadoras. La herramienta busca alinearse con los contenidos y objetivos formativos definidos en la currícula vigente.Para lograr este objetivo, se plantean los siguientes objetivos específicos:
