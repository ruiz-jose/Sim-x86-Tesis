...
La tabla \protect\hyperlink{ref-ref}{\textbf{ref?}}(tab:tablaregistros) presenta los códigos binarios y decimales correspondientes a los registros de propósito general AL, BL, CL y DL, los cuales pueden ser utilizados como Rx y Ry en las instrucciones del simulador.
...
\item
  ...
  En este caso, el resultado de la operación se almacena en una posición de memoria especificada en la instrucción o indicada por el contenido del registro BL.
...
\hypertarget{gestion-dispositivos-e-interrupciones}{%
\section{Gestion dispositivos e interrupciones}\label{gestion-dispositivos-e-interrupciones}}
...
El simulador VonSim8 incluye un teclado y una pantalla como dispositivos de entrada y salida, respectivamente. Estos dispositivos permiten la interacción básica entre el usuario y el sistema, facilitando la entrada de datos y la visualización de resultados.
...
Para poder interactuar con los módulos de entrada y salida y la pila es necesario presentar nuevas instrucciones al conjunto de instrucciones del procesador.
...
\hypertarget{muxf3dulo-de-entradasalida}{%
\subsection{Módulo de Entrada/Salida}\label{muxf3dulo-de-entradasalida}}
...
\item
  Teclado y pantalla.
\item
  Un PIO que puede conectarse a llaves y leds o a una impresora.
\item
  Un PIC que interactura con la tecla F10 para interrumpir, y un timer con su reloj.
\item
  Handshake: que puede conectar a un PIO o un PIC.
\end{itemize}
...
El componente chipSelect se encarga de habilitar el dispositivo que se desea utilizar en cada momento. Este componente recibe las señales de control del CPU y las señales de estado de los dispositivos, y genera las señales de selección de chip (CS) para cada dispositivo.
...
\hypertarget{llaves-y-leds}{%
\subsection{Llaves y Leds}\label{llaves-y-leds}}
