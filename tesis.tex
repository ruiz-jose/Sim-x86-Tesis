...
\begin{longtable}[]{@{}ll@{}}
\caption{\label{tab:bloquesfuncionales}Bloque funcionales principales}\tabularnewline
\toprule
...
\toprule
\cellcolor[HTML]{D3D3D3}{\textbf{Componente}} & \cellcolor[HTML]{D3D3D3}{\textbf{Características}}\\
\midrule
Arquitectura & - von Neumann, con memoria compartida para datos e instrucciones.\\
...
Instrucciones & - Longitud variable (1, 2 y 3 bytes).\\
