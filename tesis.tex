...
El repertorio de instrucciones, conocido como \textbf{ISA (Instruction Set Architecture)}, define el conjunto de operaciones que un procesador puede ejecutar y cómo se codifican dichas operaciones. Este conjunto incluye instrucciones aritméticas, lógicas, de control y manipulación de datos, además de los modos de direccionamiento y formatos de las instrucciones. El diseño de un ISA influye considerable en el rendimiento, la eficiencia energética y la flexibilidad de la arquitectura de un procesador {[}\protect\hyperlink{ref-hennessy_computer_2012}{13}{]}, {[}\protect\hyperlink{ref-stallings_computer_2013}{14}{]}, {[}\protect\hyperlink{ref-null_essentials_2014}{22}{]}.
...
\tightlist
\item
  \textbf{Tipos de operandos}: los tipos de datos que las instrucciones pueden manipular, tales como enteros, números en punto flotante, caracteres y direcciones de memoria. Un ISA bien diseñado soporta eficientemente diversos tipos de operandos.
\item
  \textbf{Tipos de operaciones}: las operaciones que el procesador es capaz de realizar, incluyendo aritmética (suma, resta), lógica (AND, OR), control (saltos, llamadas a subrutinas) y manipulación de datos (movimiento de datos, almacenamiento, carga).
\item
  \textbf{Modos de direccionamiento}: los métodos para especificar operandos en las instrucciones, como inmediato, directo, indirecto y relativo, cada uno con ventajas en términos de flexibilidad y eficiencia.
\item
  \textbf{Formato de las instrucciones}: la estructura de una instrucción, que define su longitud, número de operandos y modos de direccionamiento. Este aspecto impacta directamente en la complejidad y eficiencia del procesador.
\end{itemize}
