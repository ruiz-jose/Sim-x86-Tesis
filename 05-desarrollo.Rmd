...
modosdireccionamiento <- data.frame(
  Destino = c("Registro Rx",  "Memoria", "Dirección"),
  Fuente = c(    
    if (knitr::is_latex_output()) {
      "Puede ser:\\begin{itemize} \\item registro Ry (1)\\item dirección [M] (2)\\item dirección registro [BL] (3)\\item valor inmediato d (4)\\end{itemize}" # nolint: line_length_linter.
    } else {
