...
### Etapa 1: Captación
Esta etapa es igual para todas las instrucciones. Su objetivo es leer la instrucción desde la memoria y cargarla en el **Registro de Instrucciones** (`IR`) para su posterior decodificación. Consta de tres microoperaciones:
...
Estos valores pueden modificarse para realizar análisis de rendimiento o comparar configuraciones de memoria y control.
