...
arq <- data.frame(
  ...
  `Características` = c("Von Neumann, memoria compartida para datos e instrucciones.", # nolint
                        ...
                        "2 registros dedicados a la transferencia de información entre la CPU y la memoria principal: MAR (Memory Address Register), que almacena direcciones de memoria, y MBR (Memory Buffer Register), que guarda los datos a transferir.", # nolint
                        ...
                        "Las instrucciones presentan una longitud variable (1, 2 o 3 bytes), y admiten múltiples modos de direccionamiento: registro a registro, directo, indirecto e inmediato."), # nolint: line_length_linter.
