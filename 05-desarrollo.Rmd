...
```{r resaltadoipsp, echo=FALSE, fig.cap="Resaltado registro IP y registro SP", fig.align = 'center', out.width = "100%"}
...
```{r resaltadoint, echo=FALSE, fig.cap="Resaltado vector de interrupciones", fig.align = 'center', out.width = "50%"}
...
```{r org, echo=FALSE, fig.cap="Compatibilidad directiva ORG y END", fig.align = 'center', out.width = "100%"}
