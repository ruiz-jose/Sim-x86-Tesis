...
Representar gráficamente la CPU, los buses, la memoria y los dispositivos de entrada/salida. Esta visualización debe destacar los componentes activos en cada etapa del ciclo de ejecución, facilitando una comprensión sistémica e integrada del funcionamiento de la computadora [@w3c_accessibility_2021]. El uso de representaciones gráficas como recurso didáctico está respaldado por estudios que demuestran su efectividad para facilitar la comprensión de conceptos abstractos en disciplinas técnicas [@sorva2013visualizations]. La Figura \@ref(fig:diagramasimulador) ilustra la estructura general del simulador, destacando los principales módulos funcionales y sus interacciones. Esta representación gráfica facilita la comprensión de cómo los componentes del simulador trabajan en conjunto durante la ejecución de un programa.
...
Con el objetivo de evaluar la eficacia del simulador VonSim8 en la enseñanza de arquitectura de computadoras, se diseñó una prueba piloto con estudiantes de segundo año de la carrera de Licenciatura en Sistemas. La validación se orientó a medir la comprensión de conceptos fundamentales tales como el ciclo de instrucción, la manipulación de registros y la gestión de interrupciones.

### Objetivos de la validación

- Determinar el impacto del simulador en la comprensión de los conceptos clave de arquitectura de computadoras.
...
La prueba piloto se realizó con un grupo de 30 estudiantes matriculados en la asignatura Arquitectura de Computadoras, pertenecientes al segundo año de la carrera de Licenciatura en Sistemas. La selección se realizó de manera voluntaria, garantizando la representatividad de los participantes en relación con el perfil típico de la asignatura.

### Instrumentos de recolección de datos

Para la validación se emplearon los siguientes instrumentos:

- **Encuestas pre y post-uso:** Aplicadas antes y después de la utilización del simulador, orientadas a medir la autopercepción de conocimientos y habilidades.
- **Cuestionarios de conocimiento:** Pruebas objetivas sobre conceptos específicos (ciclo de instrucción, registros, interrupciones) administradas en ambos momentos.
- **Registro de tiempo de uso:** Análisis del tiempo dedicado por cada estudiante a la interacción con el simulador.
- **Entrevistas semiestructuradas:** Realizadas a una muestra de participantes para profundizar en la experiencia de uso y recoger sugerencias de mejora.

### Análisis de datos

Los resultados se analizarán mediante técnicas cuantitativas y cualitativas:

- **Comparación de puntajes pre y post-uso:** Se emplearán pruebas estadísticas (t de Student para muestras relacionadas) para determinar diferencias significativas en el nivel de conocimiento.
- **Análisis descriptivo del tiempo de uso:** Se correlacionará el tiempo de interacción con el simulador y la mejora en los puntajes.
- **Análisis temático de entrevistas:** Se identificarán patrones recurrentes en las percepciones y sugerencias de los estudiantes.

Esta metodología permitirá validar el impacto pedagógico del simulador y orientar futuras mejoras en función de la evidencia recogida.
