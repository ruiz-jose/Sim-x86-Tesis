...
La implementación en xdevs.py reproduce fielmente las 11 microoperaciones del ciclo completo (6 en FETCH + 5 en EXECUTE), generando 45 transiciones DEVS y requiriendo 14 ciclos totales. Los resultados confirman:

- **Correctitud funcional**: la transferencia AL ← BL se ejecuta correctamente (`AL: 0x01 → 0x0A`).
