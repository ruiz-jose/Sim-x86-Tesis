...
- Z: 1 si el resultado = 0x00; 0 en caso contrario.
...
### Estadísticas de CPU (CPI y tiempo de CPU) en VonSim8

VonSim8 utiliza un modelo temporal didáctico donde cada “paso” del ciclo se contabiliza como un ciclo de CPU. En consecuencia:
