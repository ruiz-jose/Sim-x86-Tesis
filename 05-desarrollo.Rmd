...
Para evaluar la efectividad del simulador VonSim8 en la enseñanza de arquitectura de computadoras, se llevó a cabo una prueba piloto en el año 2025, durante el segundo cuatrimestre, con estudiantes de segundo año de la Licenciatura en Sistemas. La muestra incluyó 30 alumnos. El propósito principal fue medir el grado de comprensión de conceptos esenciales, como el ciclo de instrucción, la manipulación de registros y la gestión de interrupciones.

### Objetivos de la validación

- Analizar el impacto del simulador en la comprensión de los conceptos fundamentales de arquitectura de computadoras.
- Detectar mejoras en la capacidad de los estudiantes para analizar y depurar programas en ensamblador.
- Valorar la percepción de usabilidad y utilidad didáctica de la herramienta.

### Población de estudio

La prueba piloto involucró a 30 estudiantes matriculados en la asignatura Arquitectura de Computadoras, correspondiente al segundo año de la carrera. La participación fue voluntaria, asegurando la representatividad respecto al perfil típico de la materia.

### Instrumentos de recolección de datos

Se emplearon diversos instrumentos para la validación:

- **Encuestas pre y post-uso:** Aplicadas antes y después de utilizar el simulador, para medir la autopercepción de conocimientos y habilidades.
...
- **Comparación de puntajes pre y post-uso:** Se aplicarán pruebas estadísticas (t de Student para muestras relacionadas) para identificar diferencias significativas en el nivel de conocimiento.
- **Análisis descriptivo del tiempo de uso:** Se estudiará la correlación entre el tiempo de interacción con el simulador y la mejora en los puntajes.
...
Esta metodología permitirá validar el impacto pedagógico del simulador y orientar futuras mejoras basadas en la evidencia obtenida.
