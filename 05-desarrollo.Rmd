...
Tambien se ocultaron los registros registro SP y  (`ri` e `id`) que se habilitan automaticamente al 
ejecutar una instrucción que requiera su uso. 

```{r idri, echo=FALSE, fig.cap="Ocultamiento automatico", fig.align = 'center', out.width = "85%"}    
knitr::include_graphics(path = "images/idri.png")
```
