...
```{r registros, echo=FALSE, fig.cap="Registro de 8 bits", fig.align = 'center', out.width = "90%"}    
...
```{r idrisp, echo=FALSE, fig.cap="Registro SP, id y ri", fig.align = 'center', out.width = "25%"}    
