...
if (knitr::is_latex_output()) {
  tabla_kable %>%
    ...
    column_spec(1, width = "2cm", bold = TRUE, border_right = TRUE, align = "c") %>%
    column_spec(2, width = "3cm", align = "c") %>%
    column_spec(3, width = "7cm", align = "l") %>%
    row_spec(0, bold = TRUE, align = "c", background = "#D3D3D3") %>%
  ...
  tabla_kable %>%
    ...
    column_spec(1, width = "6em", bold = TRUE, border_right = TRUE, align = "center") %>%
    column_spec(2, width = "10em", align = "center") %>%
    column_spec(3, width = "22em", align = "left") %>%
    row_spec(0, bold = TRUE, color = "white", background = "#0073C2")
}
``` 
