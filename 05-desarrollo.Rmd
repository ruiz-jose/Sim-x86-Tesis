...
```{r resaltadointsp, echo=FALSE, fig.cap="Resaltado vector de interrupciones", fig.align = 'center', out.width = "100%"}
...
```{r decodificador, echo=FALSE, fig.cap="Decodificador en VonSim8", fig.align = 'center', out.width = "100%"}
