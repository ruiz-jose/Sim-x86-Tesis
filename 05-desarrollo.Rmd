...
Obtener la dirección de memoria de destino (puede venir como valor inmediato, leerse desde la memoria o encontrarse en un registro como BL).

Leer o escribir datos en esa dirección según la operación:
