...
## Implementación del ciclo de instrucción para MOV AL, BL en xDEVS
...
#### Flujo de eventos y microoperaciones (RTL)
...
### Definición DEVS simplificada de cada modelo

#### Modelo Atómico: Registro (ej. AL o BL)
