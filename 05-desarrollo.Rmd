...
En caso de tener interrupciones y no indicarse la directiva `org`, el simulador asigna automáticamente la dirección 0x08 al primer byte del programa, porque las interrupciones se gestionan a partir de la dirección `0x00h` al `0x08h`. 
