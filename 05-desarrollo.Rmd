...
# Convertir a HTML
kable(bloquesfuncionales, format = "markdown", align = "l", col.names = c("Bloque", "Descripción"), 
...
if (knitr::is_latex_output()) {
  kable(arq, format = "latex", booktabs = TRUE, caption = "Componentes del CPU x86") %>%
    ...
    column_spec(1, width = "5cm") %>%  # Ajustar el ancho de la columna "Componente"
    column_spec(2, width = "10cm") %>%  # Ajustar el ancho de la columna "Características"   
} else {
  kable(arq, format = "html", table.attr = "class='table table-striped'", caption = "Componentes del CPU x86") %>%
    kable_styling(full_width = FALSE, position = "center") %>%
    column_spec(1, width = "20em") %>%  # Ajustar el ancho de la columna "Componente"
    column_spec(2, width = "40em") %>%  # Ajustar el ancho de la columna "Características"
}
```
