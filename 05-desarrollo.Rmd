...
4. **Simulación visual e interactiva de micropasos de instrucciones:**
    - Visualizar el flujo de datos mediante una representación en el nivel de transferencia entre registros (Register Transfer Level, RTL), que describe cómo los datos se mueven entre componentes internos como registros y buses durante cada etapa del ciclo de instrucción. Es común en los de Stallings [@stallings_computer_2021] la utilización de RTL para representar cada etapa del ciclo de instrucción, desde la captura (‘fetch’) hasta la ejecución (‘execute’). Este enfoque facilita la comprensión del procesador, ya que permite visualizar el recorrido de los datos entre registros y la activación de señales de control en cada etapa. 
