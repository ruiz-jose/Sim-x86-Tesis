...
El espacio destinado al vector de interrupciones en el VonSim8 es de 8 posiciones de memoria desde `0x00` a `0x07` y solamente implementa las interrupciones por software:
...
```{r editorvonsim, echo=FALSE, fig.cap="Resaltado vector de interrupciones y registro SP", fig.align = 'center', out.width = "85%"}
knitr::include_graphics(path = "images/editor.png")
```
...
comparativa_vonsim <- data.frame(
  ...
  VonSim = c(
    ...
    "Completo soporte de interrupciones por hardware y software, con PIC.",
    "Registros temporales `left` y `rigth` visibles.",
  ...
  VonSim8 = c(
    ...
    "Solo interrupciones por software: `INT 0` (fin), `INT 6` (entrada de teclado), `INT 7` (salida de cadena).",
