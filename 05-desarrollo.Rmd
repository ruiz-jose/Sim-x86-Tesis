...
| Destino   | Fuente    | Ejemplo         | Acción                                                                 |
|-----------|-----------|-----------------|------------------------------------------------------------------------|
| <td rowspan="4" align="center">Registro</td> | Registro   | MOV BL, AL       | Copiar el valor de un registro a otro                                  |
|           | Directo   | MOV AL, [dir]   | Cargar el contenido de la dirección de memoria al registro             |
|           | Indirecto | MOV AL, [BL]    | Cargar desde memoria según la dirección contenida en el registro BL    |
|           | Inmediato | MOV AL, valor   | Cargar valor inmediato a un registro                                   |
| <td rowspan="4" align="center">Memoria</td><td rowspan="2" align="center">Directo</td> | Registro   | MOV [dir], CL    | Almacenar el valor del registro en la dirección de memoria             |
|           | Inmediato | MOV [dir], valor| Almacenar el valor inmediato en memoria                               |
|           | <td rowspan="2" align="center">Indirecto</td> Registro   | MOV [BL], CL    | Almacenar en memoria según la dirección contenida en el registro BL    |
|           | Inmediato | MOV [BL], valor | Almacenar en memoria, según la dirección de BL, el valor inmediato     |
