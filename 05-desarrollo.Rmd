...
microoperaciones <- data.frame(
  ...
  Descripción = c(
    "La Unidad de Control (UC) interpreta el opcode MOV y determina los operandos AL y BL.",
    "El Banco de Registros habilita la salida del registro BL bajo control de la UC.",
    "El valor almacenado en BL se transfiere al bus compartido.",
...
tabla_microop <- kable(
  microoperaciones,
  format = ifelse(knitr::is_latex_output(), "latex", "html"),
  caption = "Secuencia de microoperaciones y eventos DEVS para la Fase de ejecución",
  col.names = c("Paso", "Microoperación", "Descripción", "Funciones DEVS"),
  booktabs = TRUE,
  escape = FALSE
)
