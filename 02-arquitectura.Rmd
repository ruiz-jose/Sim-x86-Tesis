...
```{r vonneumann, echo=FALSE, fig.cap="Arquitectura Von Neumann", fig.align = 'center', out.width = "75%"}
...
```{r harvard, echo=FALSE, fig.cap="Arquitectura Harvard", fig.align = 'center', out.width = "75%"}
...
```{r hibrida, echo=FALSE, fig.cap="Arquitectura híbridas", fig.align = 'center', out.width = "75%"}
...
comparq <- data.frame(
  Característica = c(
    ...
    "Complejidad del repertorio de instrucciones (ISA)",
    "Rendimiento típico",
    "Ámbito de aplicación principal"
  ),
  x86 = c(
    "Moderada-alta, depende de la microarquitectura",
    "Alta (ISA extensa, instrucciones de longitud variable)",
    "Elevado en entornos de escritorio y servidores",
    "Computadoras personales, servidores, software legado"
  ),
  ARM = c(
    "Alta, optimizada para dispositivos móviles",
    "Baja (ISA reducida, instrucciones simples y de longitud fija)",
    "Moderado/alto en sistemas embebidos y móviles",
    "Dispositivos móviles, sistemas embebidos, IoT"
  ),
  `RISC-V` = c(
    "Alta, diseño abierto y eficiente",
    "Baja (ISA modular, extensible y de longitud fija)",
    "Moderado, escalable según extensiones implementadas",
    "Investigación, docencia, aplicaciones personalizadas"
  ),
...
tabla <- kable(comparq,
               format = ifelse(knitr::is_latex_output(), "latex", "html"),
               caption = "Comparación de arquitecturas x86, ARM y RISC-V",
               col.names = c("Característica", "x86", "ARM", "RISC-V"),
               booktabs = TRUE,
               escape = FALSE,
               align = c("l","l","l","l"))
...
if (knitr::is_latex_output()) {
  tabla %>%
    ...
    row_spec(0, bold = TRUE, align = "c", background = "#D3D3D3") %>%
    row_spec(seq_len(nrow(comparq)), extra_latex_after = "\\addlinespace[16pt]")
} else {
  tabla %>%
    kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
...
```{r ModDir, echo=FALSE, fig.cap="Modos de direccionamiento ", fig.align = 'center', out.width="70%"}
...
```{r convergen, echo=FALSE, fig.cap="Convergencia de filosofías", fig.align = 'center', out.width = "70%"}
...
```{r ensambla, echo=FALSE, fig.cap="Proceso de ensamblado", fig.align = 'center', out.width = "95%"}
