...
Para facilitar la programación a bajo nivel, surgió el lenguaje ensamblador. Este lenguaje permite a los programadores escribir instrucciones más comprensibles mediante mnemónicos simbólicos, que actúan como representaciones legibles de las instrucciones en lenguaje máquina. Cada arquitectura de procesador define su propio conjunto de instrucciones (ISA, *Instruction Set Architecture*), y por lo tanto, cuenta con un lenguaje ensamblador específico, adaptado a sus características funcionales y estructurales [@stallings_computer_2021].
