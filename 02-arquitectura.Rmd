...
La arquitectura Von Neumann, formalizada por John von Neumann en 1945, se basa en un modelo en el cual tanto los datos como las instrucciones residen en una única memoria y comparten un mismo bus de comunicación. Esta unificación facilita el diseño del sistema, aunque genera una limitación conocida como el *cuello de botella de Von Neumann*, que restringe el acceso concurrente a datos e instrucciones. Este fenómeno limita el rendimiento del sistema, ya que impide el acceso simultáneo a datos e instrucciones, generando demoras en la ejecución de programas complejos o con alto volumen de procesamiento [@hennessy_computer_2012; @stallings_computer_2021]. 
