...
comparq <- data.frame(
  ...
  RISCV = c("Alta", "Baja", "Variable", "Alta", "Investigación, embebidos")
)
...
```{r ModDir, echo=FALSE, fig.cap="Modos de direccionamiento ", fig.align = 'center', out.width="60%", fig.pos='htbp'}
