...
En respuesta a las demandas de mayor eficiencia energética y rendimiento, la arquitectura de computadoras ha evolucionado hacia diseños más especializados [@hennessy_computer_2012]. Por ejemplo, ARM y RISC-V son arquitecturas que priorizan la simplicidad estructural y el bajo consumo energético, lo cual ha favorecido su adopción en dispositivos móviles y sistemas embebidos [@waterman_risc-v_2014; @harris2015digital; @null_essentials_2014]. Estas soluciones contrastan con el enfoque más complejo de la arquitectura x86, que ha derivado en un modelo híbrido con características tanto de CISC como de RISC para responder a los requerimientos crecientes del mercado [@bryant2015computer; @stallings_computer_2013; @patterson_computer_2014].
