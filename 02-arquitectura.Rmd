...
tabla <- kable(hitosx86,
               format = ifelse(knitr::is_latex_output(), "latex", "html"),
               caption = "Comparación de ensambladores para la arquitectura x86",
