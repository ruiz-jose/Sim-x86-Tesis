...
La disciplina de arquitectura de computadoras constituye un pilar central en la informática, enfocada en el diseño y la organización de los componentes que conforman un sistema computacional. Esta área abarca tanto el hardware como el software, y su comprensión es esencial para el desarrollo de sistemas eficientes y potentes. La arquitectura de computadoras no solo alude a la estructura física de los componentes, sino también a la forma en que interactúan entre ellos y con el software [@stallings_computer_2013; @tanenbaum_structured_2013; @murdocca_principles_2000; @bryant2015computer].

Es importante diferenciar entre **arquitectura de computadoras**, que describe los componentes funcionales visibles al programador, y **organización de computadoras**, que se refiere a la implementación física de dichos componentes. Esta última considera cómo se estructuran y coordinan elementos del hardware, como las unidades de procesamiento, la memoria y las señales de control, con el fin de cumplir los objetivos de rendimiento y funcionalidad [@stallings_computer_2013; @tanenbaum_structured_2013; @murdocca_principles_2000]. La arquitectura de computadoras abarca el diseño de elementos como el conjunto de instrucciones, la organización de la memoria y los mecanismos de entrada/salida. Estos elementos inciden directamente en el rendimiento y la eficiencia del sistema, lo cual resulta crucial para el desarrollo de tecnologías emergentes, como sistemas de bajo consumo, computación en la nube o dispositivos embebidos. [@stallings_computer_2013; @tanenbaum_structured_2013; @murdocca_principles_2000; @hennessy_computer_2012; @bryant2015computer].

La arquitectura de computadoras evoluciona constantemente para mejorar rendimiento y eficiencia energética [@hennessy_computer_2012]. Este desarrollo ha generado arquitecturas especializadas como ARM y RISC-V, ideales para dispositivos móviles y sistemas embebidos [@waterman_risc-v_2014; @harris2015digital; @null_essentials_2014].

Una comprensión integral de la arquitectura de computadoras requiere analizar atributos clave como el repertorio de instrucciones (por ejemplo, x86 o ARM), la capacidad de procesamiento (32 o 64 bits), las técnicas de direccionamiento de memoria (directo o segmentado), la jerarquía de memoria y los mecanismos de entrada y salida [@stallings_computer_2013; @bryant2015computer; @null_essentials_2014]. También son relevantes aspectos como el paralelismo y la eficiencia energética, los cuales resultan fundamentales tanto para mejorar el rendimiento del hardware como para optimizar el desarrollo de software y sistemas operativos contemporáneos [@hennessy_computer_2012; @patterson_computer_2014].

El estudio de la arquitectura de computadoras no solo brinda herramientas para comprender el funcionamiento interno de los sistemas informáticos, sino que también facilita su adaptación y optimización frente a las exigencias de nuevas tendencias tecnológicas como la computación en la nube, la inteligencia artificial y el internet de las cosas [@stallings_computer_2013; @tanenbaum_structured_2013; @patterson2016computer; belli2020iot].

En síntesis, la arquitectura de computadoras constituye una disciplina estratégica que habilita la comprensión profunda de los sistemas informáticos y su adaptación a nuevos contextos tecnológicos. Su estudio es fundamental para abordar desafíos en ámbitos como la inteligencia artificial, la ciberseguridad o el desarrollo de sistemas embebidos. Este conocimiento habilita la resolución de desafíos tecnológicos emergentes y potencia la inserción profesional en sectores que demandan competencias en diseño y optimización de sistemas complejos [@patterson2016computer; @stallings_computer_2013; @harris2015digital].
