...
```{r evasimuedu, echo=FALSE, out.width = "100%", fig.cap="Evaluación del simulador educativo"}
library(knitr)
library(kableExtra)
...
xdevs-vonsim8^[xdevs-vonsim8: https://github.com/ruiz-jose/xdevs-vonsim8] [@ruiz2025-xdevsvonsim8].
