...
```{r ModDir, echo=FALSE, fig.cap="Modos de direccionamiento [@stallings_computer_2013]", fig.align = 'center', out.width = "80%"}
...
```{r FormatoInst, echo=FALSE, fig.cap="Formato de instrucciones x86 [@stallings_computer_2013]", fig.align = 'center', out.width = "100%"}
