...
```{r comparativa_cisc_risc, echo=FALSE, message=FALSE, warning=FALSE}
# Cargar librería necesaria
library(knitr)

# Crear un data frame con la información comparativa
comparativa_cisc_risc <- data.frame(
...
kable(comparativa_cisc_risc, format = "markdown", caption = "Comparativa entre CISC y RISC")
```
