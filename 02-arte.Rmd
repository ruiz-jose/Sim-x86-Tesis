...
El repertorio de instrucciones define las operaciones que un procesador puede realizar y cómo se ejecutan. Sus funciones principales incluyen [@stallings_computer_2013]:

- **Control de la CPU**: Instrucciones de control que gestionan la secuencia de ejecución, interrupciones y llamadas a subrutinas, asegurando que el procesador funcione de manera ordenada y eficiente.

- **Interacción con la memoria**: Las instrucciones permiten que la CPU cargue y almacene datos desde y hacia la memoria principal, un aspecto crítico para la ejecución de programas y la optimización del rendimiento global del sistema.

- **Gestión de datos**: Las operaciones aritméticas, lógicas y de comparación son esenciales para la manipulación de datos. Un diseño adecuado del repertorio puede simplificar y acelerar estas operaciones, mejorando tanto el rendimiento como el consumo energético del sistema.

- **Optimización del rendimiento**: Un repertorio de instrucciones eficiente minimiza el número de instrucciones necesarias para completar una tarea, lo que contribuye a un uso más eficaz de los recursos del sistema, tanto en términos de energía como de tiempo de procesamiento.

### Modos de direccionamiento
Los modos de direccionamiento son fundamentales para definir cómo una CPU accede a los datos para ejecutar una instrucción [@stallings_computer_2013 ; @hennessy_computer_2012 ]. Algunos modos comunes incluyen:
...
El formato de las instrucciones determina cómo se estructuran las instrucciones en términos de longitud, número de operandos y campos adicionales como el código de operación (**opcode**) [@hennessy_computer_2012 ; @tanenbaum_structured_2013]. El formato tiene un impacto directo en la complejidad del diseño del procesador:
