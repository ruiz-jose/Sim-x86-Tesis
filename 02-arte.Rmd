...
- **Optimización del rendimiento**: Un repertorio de instrucciones eficiente minimiza el número de instrucciones para completar una tarea, mejorando el uso de energía y los recursos del sistema [@hennessy_computer_2012].
...
La Tabla \@ref(tab:data_algoritmo) indica el cálculo de la dirección realizado para cada modo de direccionamiento.

```{r data_algoritmo, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)

# Crear los datos de la tabla
data_algoritmo <- data.frame(
...
kable(data_algoritmo, format = "markdown", caption = "Modos de direccionamiento básicos")
```
...
```{r FormatoInst, echo=FALSE, fig.cap="Formato de instrucciones x86", fig.align = 'center', out.width = "100%"}
