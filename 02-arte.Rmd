...
```{r tabla-comparacion_arquitecturas, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
...
kable(comparacion_arquitecturas, format = "markdown", caption = "Comparación de Arquitecturas")
```
...
```{r casos_uso_x86, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
