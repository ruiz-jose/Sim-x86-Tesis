...
La arquitectura de computadoras se ocupa del estudio y diseño de los componentes de hardware y software de un sistema informático, así como de su interacción. Este campo abarca desde el diseño de circuitos hasta la integración de sistemas completos, siendo crucial para el desarrollo de tecnologías eficientes y avanzadas. Entender la arquitectura de una computadora implica conocer los atributos del sistema que son visibles al programador, como el conjunto de instrucciones, la cantidad de bits utilizados para representar datos, los mecanismos de entrada/salida, y las técnicas de direccionamiento. Estos aspectos son fundamentales para la optimización y el desarrollo de software y sistemas operativos [@stallings_computer_2013][@hennessy_computer_2012].

Además, la arquitectura de computadoras está estrechamente relacionada con la organización interna del hardware. La **organización** se refiere a cómo se implementa la arquitectura: cómo se interconectan y operan los componentes físicos para cumplir con el diseño establecido. Este entendimiento es esencial, pues explica cómo el hardware soporta la arquitectura definida, desde las señales de control hasta la disposición de la memoria y las unidades de procesamiento. La **estructura** del sistema se organiza en niveles jerárquicos que van desde circuitos básicos hasta aplicaciones de software de alto nivel, y el **funcionamiento** del computador sigue un ciclo básico de procesamiento: búsqueda, decodificación, ejecución y almacenamiento de instrucciones.
