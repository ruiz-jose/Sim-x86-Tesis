...
Para comprender las arquitecturas modernas, es fundamental conocer dos modelos históricos que sentaron las bases del diseño actual de sistemas: **Von Neumann** y **Harvard**. Estos dos paradigmas son esenciales para comprender las diferencias y ventajas de las arquitecturas contemporáneas.

### Arquitectura Von Neumann
La **arquitectura Von Neumann**, formulada por John von Neumann en 1945, utiliza un único espacio de memoria para almacenar tanto los datos como las instrucciones, y un solo bus para transferir ambos tipos de información. Este diseño ha sido ampliamente adoptado debido a su simplicidad, pero introduce limitaciones como el "cuello de botella de Von Neumann", donde el bus único se convierte en un factor limitante para la velocidad de procesamiento. Este fenómeno es especialmente relevante en sistemas donde el acceso simultáneo a datos e instrucciones es crítico. Aunque la arquitectura Von Neumann sigue siendo la base de muchas computadoras actuales, se han implementado diversas optimizaciones para mejorar su rendimiento en sistemas modernos [@hennessy_computer_2012; @stallings_computer_2013].

### Arquitectura Harvard
Por otro lado, la **arquitectura Harvard** separa físicamente las memorias de datos y de instrucciones, permitiendo que el procesador acceda a ambas de manera simultánea. Este enfoque ofrece un rendimiento más eficiente al eliminar el cuello de botella de Von Neumann, siendo particularmente útil en sistemas embebidos y aplicaciones que requieren un alto rendimiento, como los procesadores de señal digital (DSP) [@tanenbaum_structured_2013].

### Comparación y aplicaciones modernas
Aunque la arquitectura Von Neumann sigue siendo ampliamente utilizada debido a su simplicidad y flexibilidad, la arquitectura Harvard ha ganado popularidad en sistemas donde la eficiencia y la velocidad son primordiales, como en dispositivos móviles y sistemas de tiempo real. Hoy en día, muchas arquitecturas modernas, como **x86**, **ARM** y **RISC-V**, adoptan una combinación de ambos modelos, Von Neumann y Harvard, para maximizar tanto el rendimiento como la eficiencia energética [@null_essentials_2014].
