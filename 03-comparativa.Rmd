...
Este capítulo compara diversos simuladores x86 que podrían integrarse en la asignatura de Arquitectura de Computadoras de la Licenciatura en Sistemas. La selección y evaluación de estos simuladores se basa en criterios específicos diseñados para medir su efectividad en un entorno educativo. El objetivo principal es identificar las herramientas que mejor apoyen el proceso de enseñanza-aprendizaje, facilitando tanto la comprensión teórica como la aplicación práctica de los conceptos de arquitectura de computadoras.
...
##   Resultados
Desde la asignatura se incentiva el uso de simuladores para apoyar los procesos de enseñanza y aprendizaje, pero también se fomenta que los contenidos desarrollados puedan trasladarse a máquinas reales. En este sentido, consideramos que el enfoque planteado por la herramienta Emu8086 es el más adecuado para la asignatura, ya que facilita la implementación de programas en máquinas reales. Sin embargo, presenta el inconveniente de generar ejecutables dependientes del sistema operativo MS-DOS, lo que dificulta su ejecución en sistemas operativos actuales. Esto obliga a utilizar emuladores de MS-DOS para poder ejecutarlos, lo que añade otra capa de complejidad a los procesos de enseñanza y aprendizaje.
