...
- **Editor**: Soporte para escribir y depuración de código en lenguaje ensamblador.
  - **Indicadores**: 
...
- **Documentación**: Disponibilidad de soporte para el aprendizaje, repertorio de instrucciones, manual de usuario.
  - **Indicadores**: 
...
- **Características del desarrollo del producto software**: Tipo de licencia (open source o privativas),  la fecha de última versión, y si es una aplicación web o de escritorio.
  - **Indicadores**: 
