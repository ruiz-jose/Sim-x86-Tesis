...
```{r simuladores_tabla, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
...
simuladores <- data.frame(
  ...
  `Exploración Previa` = c("✔", "✔", "✔", "✔", "✔", "✔", "✔", "✔"),
  `Evaluación Final` = c("✘", "✔", "✘", "✘", "✔", "✔", "✘", "✘")
)

kable(simuladores, format = "latex", booktabs = TRUE, caption = "Proceso de selección de simuladores") %>%
  kable_styling(latex_options = c("hold_position"))
```
