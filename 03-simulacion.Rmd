...
```{r aplisimu, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
...
```{r devs, echo=FALSE, fig.cap="Relación entre modelos atómicos y modelos acoplados en DEVS", fig.align = 'center', out.width = "45%"}
...
```{r acoplado, echo=FALSE, fig.cap="Modelo acoplado en DEVS", fig.align = 'center', out.width = "65%"}
