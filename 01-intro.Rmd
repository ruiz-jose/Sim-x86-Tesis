# Introducción
En nuestra vida cotidiana, utilizamos una amplia variedad de dispositivos, desde computadoras de escritorio hasta teléfonos y relojes inteligentes, todos los cuales operan bajo arquitecturas específicas. Comprender cómo funcionan estos componentes y cómo interactúan nos permite diseñar, desarrollar e implementar aplicaciones más eficientes.

Los estudiantes de la asignatura Arquitectura de Computadoras deben conocer no solo la estructura y el funcionamiento interno de una computadora, sino también adquirir experiencia práctica con esta arquitectura.

Para brindar esta experiencia, es fundamental contar con un laboratorio equipado con el hardware necesario y el tiempo suficiente para que los estudiantes adquieran competencia en el uso de herramientas prácticas. Por esta razón, se han desarrollado numerosos simuladores que facilitan la comprensión del funcionamiento y la estructura de las computadoras, ofreciendo valiosas experiencias de aprendizaje.

La presente tesis, inscrita en la Maestría en Sistemas de Información de la Facultad de Ciencias de la Administración, está directamente vinculada con el proyecto de investigación I/D novel PID-UNER 7065: “Enseñanza/aprendizaje de Arquitectura de Computadoras con herramientas de simulación de sistemas de cómputo”, desarrollado en la Facultad de Ciencias de la Administración de la Universidad Nacional de Entre Ríos [@colombani_pid_2022].
...
Como primer paso en su comprensión, los estudiantes deben entender que las computadoras son máquinas que toman datos del exterior, los procesan y obtienen resultados que almacenan en la memoria o envían a dispositivos de entrada y salida.
...
Un simulador de arquitectura es una herramienta que imita el hardware de un sistema, enfocándose en la representación de los aspectos arquitectónicos y las funciones del hardware simulado. Estas herramientas permiten realizar cambios, pruebas y ejecutar programas sin riesgo de dañar componentes ni depender de la disponibilidad de equipos físicos [@radivojevic_design_2011].
...
Para proporcionar esta experiencia es necesario un laboratorio con el hardware necesario y el tiempo para que los estudiantess se vuelvan competentes en el uso de herramientas para trabajar con el hardware. Por este motivo, muchos simuladores han sido desarrollados, ayudando al estudiante a comprender el funcionamiento y la estructura del computador proporcionando valiosas experiencias de aprendizaje [@skrien_cpu_2001]. 
