...
Los estudiantes de la asignatura Arquitectura de Computadoras deben conocer tanto la estructura como el funcionamiento interno de la computadora y, además, tener una experiencia práctica con dicha arquitectura.
...
\tightlist
\item
  \textbf{Usabilidad}: Nivel medio. Presenta todos los componentes en una sola pantalla, lo cual puede ser abrumador para usuarios iniciales.
\item
