...
data <- data.frame(
  ...
  Acción = c(
    htmltools::HTML("- Copiar entre registros - Almacenar en memoria - Cargar a registro"),
...
# Convertir a HTML
kable(data, format = "markdown", escape = FALSE, align = "l", col.names = c("Instrucciones", "Código operación", "Acción"), 
