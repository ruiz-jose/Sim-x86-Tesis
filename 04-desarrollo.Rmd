...
Este capitulo se enfoca en el diseño y construcción de una herramienta de simulación de la arquitectura x86 para apoyar la enseñanza de arquitectura de computadoras. En el capitulo anterior, se Estudió y evaluó diferentes herramientas actuales de simulación destinadas a apoyar la enseñanza de la arquitectura x86. Este objetivo se cumplió mediante una revisión exhaustiva de las herramientas de simulación disponibles y posterior publicación de los resultados.

Para cumplir este objetivo especifico, la herramienta debe cumplir una serie de requisitos mencionados anteriormente que debe cumplir la herramienta, se diseña la arquitectura, construye y prueba. 
