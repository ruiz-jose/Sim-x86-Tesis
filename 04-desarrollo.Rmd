...
# Crear los datos con HTML para las viñetas
data <- data.frame(
  Instrucciones = c(
  ...
  Acción = c(
    htmltools::HTML("<ul><li>Copiar entre registros</li><li>Almacenar en memoria</li><li>Cargar a registro</li></ul>"),
...
# Convertir a HTML
kable(data, escape = FALSE, align = "l", col.names = c("Instrucciones", "Código operación", "Acción"), 
