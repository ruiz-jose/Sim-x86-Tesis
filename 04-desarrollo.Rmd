...
| 1 | `MOV Rx, [BL]`     | `Rx` $\leftarrow$ `Mem[BL]`                                        | `0001 00ZZ`                   |
| 1 | `MOV Rx, [M]`      | `Rx` $\leftarrow$ `Mem[Dirección]`                                 | `0001 01ZZ DDDDDDDD`          |
| 1 | `MOV Rx, D`        | `Rx` $\leftarrow$ `Dato`                                           | `0001 10ZZ DDDDDDDD`          |
| 1 | `MOV Rx, [BL + D]` | `Rx` $\leftarrow$ `Mem[BL + Dato]`                                 | `0001 11ZZ DDDDDDDD`          |
| 2 | `MOV [BL], Rx`     | `Mem[BL]` $\leftarrow$ `Rx`                                        | `0010 00ZZ`                   |
| 2 | `MOV [M], Rx`      | `Mem[Dirección]` $\leftarrow$ `Rx`                                 | `0010 01ZZ DDDDDDDD`          |
| 2 | `MOV [M], D`       | `Mem[Dirección]` $\leftarrow$ `Dato`                               | `0010 1000 DDDDDDDD DDDDDDDD` |
| 2 | `MOV [BL], D`      | `Mem[BL]` $\leftarrow$ `Dato`                                      | `0010 1001 DDDDDDDD`          |
| 2 | `MOV [BL + D], D`  | `Mem[BL + Dato]` $\leftarrow$ `Dato`                               | `0010 1010 DDDDDDDD DDDDDDDD` |
| 2 | `MOV [BL + D], Rx` | `Mem[BL + Dato]` $\leftarrow$ `Rx`                                 | `0010 11ZZ DDDDDDDD`          |
...
| C | `Jxx M`            | Se pueden implemementar más flags y CALL                           | `1100 xxxx --------`          |
...
- `D`: el operando fuente es un valor inmediato
- `[R]`: indirecto por registro,	Contenido de la dirección de memoria esta dada por el registro BL
