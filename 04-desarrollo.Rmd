...
kable(arq, align = c("l", "l"), escape = FALSE)
```
...
setreducido <- data.frame(
  ...
  Acción = c( "0- Copiar entre registros",
    ...
    "6-7-8 Restar",
    "9-10-11 Comparar",
    "12-a Saltos condicionales",
    "12-b Saltos incondicionales"
  )
)

# Convertir a HTML
kable(setreducido, format = "markdown", align = "l", col.names = c("Código operación", "Instrucciones", "nemónico", "Acción"), 
