...
Las instrucciones están codificadas con 1, 2 o 3 bytes. Los primeros 4 bits identifican el `opcode` de la instrucción, el resto de los bits indican los parámetros. Existen 4 posibles codificaciones de parámetros.
...
| C: directo: memoria/inmediato a registro| `OOOO mmZZ DDDDDDDD` | `mm` = modo `D` = Dirección de memoria o Dato Inmediato  |
| D: directo: inmediato a memoria| `OOOO  mmmm DDDDDDDD` | `DDDDDDDD` = Dirección de memoria o Inmediato |
...
| `MOV Rx, [M]`          | `Rx` $\leftarrow$ `Mem[M]`                                         | `0001 XX DDDDDDDD`        |
