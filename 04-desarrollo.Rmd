...
| | - 4 registros de propósito general, `AL`, `BL`, `DL` y `DL`. |
...
| --- | --- | --- |
| A | `OOOO XXYY` | `XX` = Registro destino, `YY` = Registro fuente |
| B | `OOOO XXmm DDDDDDDD` | `XX` = Registro destino |
| C | `OOOO ---MMMMMMMM` | `MMMMMMMM` = Dirección de memoria o Inmediato |

Considerando:

- `Rx` o `Ry`: Índices de registros, número entre `0` y `3`.
